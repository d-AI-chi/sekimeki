 ...
 */var Tp;function r0(){if(Tp)return oe;Tp=1;var r=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.provider"),u=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),x=Symbol.iterator;function y(S){return S===null||typeof S!="object"?null:(S=x&&S[x]||S["@@iterator"],typeof S=="function"?S:null)}var N={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},R=Object.assign,F={};function z(S,A,se){this.props=S,this.context=A,this.refs=F,this.updater=se||N}z.prototype.isReactComponent={},z.prototype.setState=function(S,A){if(typeof S!="object"&&typeof S!="function"&&S!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,S,A,"setState")},z.prototype.forceUpdate=function(S){this.updater.enqueueForceUpdate(this,S,"forceUpdate")};function L(){}L.prototype=z.prototype;function U(S,A,se){this.props=S,this.context=A,this.refs=F,this.updater=se||N}var j=U.prototype=new L;j.constructor=U,R(j,z.prototype),j.isPureReactComponent=!0;var Q=Array.isArray,ie=Object.prototype.hasOwnProperty,re={current:null},Z={key:!0,ref:!0,__self:!0,__source:!0};function ce(S,A,se){var ue,pe={},me=null,Ee=null;if(A!=null)for(ue in A.ref!==void 0&&(Ee=A.ref),A.key!==void 0&&(me=""+A.key),A)ie.call(A,ue)&&!Z.hasOwnProperty(ue)&&(pe[ue]=A[ue]);var ye=arguments.length-2;if(ye===1)pe.children=se;else if(1<ye){for(var Pe=Array(ye),Ct=0;Ct<ye;Ct++)Pe[Ct]=arguments[Ct+2];pe.children=Pe}if(S&&S.defaultProps)for(ue in ye=S.defaultProps,ye)pe[ue]===void 0&&(pe[ue]=ye[ue]);return{$$typeof:r,type:S,key:me,ref:Ee,props:pe,_owner:re.current}}function we(S,A){return{$$typeof:r,type:S.type,key:A,ref:S.ref,props:S.props,_owner:S._owner}}function fe(S){return typeof S=="object"&&S!==null&&S.$$typeof===r}function Re(S){var A={"=":"=0",":":"=2"};return"$"+S.replace(/[=:]/g,function(se){return A[se]})}var We=/\/+/g;function rt(S,A){return typeof S=="object"&&S!==null&&S.key!=null?Re(""+S.key):A.toString(36)}function Mt(S,A,se,ue,pe){var me=typeof S;(me==="undefined"||me==="boolean")&&(S=null);var Ee=!1;if(S===null)Ee=!0;else switch(me){case"string":case"number":Ee=!0;break;case"object":switch(S.$$typeof){case r:case e:Ee=!0}}if(Ee)return Ee=S,pe=pe(Ee),S=ue===""?"."+rt(Ee,0):ue,Q(pe)?(se="",S!=null&&(se=S.replace(We,"$&/")+"/"),Mt(pe,A,se,"",function(Ct){return Ct})):pe!=null&&(fe(pe)&&(pe=we(pe,se+(!pe.key||Ee&&Ee.key===pe.key?"":(""+pe.key).replace(We,"$&/")+"/")+S)),A.push(pe)),1;if(Ee=0,ue=ue===""?".":ue+":",Q(S))for(var ye=0;ye<S.length;ye++){me=S[ye];var Pe=ue+rt(me,ye);Ee+=Mt(me,A,se,Pe,pe)}else if(Pe=y(S),typeof Pe=="function")for(S=Pe.call(S),ye=0;!(me=S.next()).done;)me=me.value,Pe=ue+rt(me,ye++),Ee+=Mt(me,A,se,Pe,pe);else if(me==="object")throw A=String(S),Error("Objects are not valid as a React child (found: "+(A==="[object Object]"?"object with keys {"+Object.keys(S).join(", ")+"}":A)+"). If you meant to render a collection of children, use an array instead.");return Ee}function qt(S,A,se){if(S==null)return S;var ue=[],pe=0;return Mt(S,ue,"","",function(me){return A.call(se,me,pe++)}),ue}function pt(S){if(S._status===-1){var A=S._result;A=A(),A.then(function(se){(S._status===0||S._status===-1)&&(S._status=1,S._result=se)},function(se){(S._status===0||S._status===-1)&&(S._status=2,S._result=se)}),S._status===-1&&(S._status=0,S._result=A)}if(S._status===1)return S._result.default;throw S._result}var De={current:null},W={transition:null},X={ReactCurrentDispatcher:De,ReactCurrentBatchConfig:W,ReactCurrentOwner:re};function H(){throw Error("act(...) is not supported in production builds of React.")}return oe.Children={map:qt,forEach:function(S,A,se){qt(S,function(){A.apply(this,arguments)},se)},count:function(S){var A=0;return qt(S,function(){A++}),A},toArray:function(S){return qt(S,function(A){return A})||[]},only:function(S){if(!fe(S))throw Error("React.Children.only expected to receive a single React element child.");return S}},oe.Component=z,oe.Fragment=n,oe.Profiler=l,oe.PureComponent=U,oe.StrictMode=s,oe.Suspense=p,oe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=X,oe.act=H,oe.cloneElement=function(S,A,se){if(S==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+S+".");var ue=R({},S.props),pe=S.key,me=S.ref,Ee=S._owner;if(A!=null){if(A.ref!==void 0&&(me=A.ref,Ee=re.current),A.key!==void 0&&(pe=""+A.key),S.type&&S.type.defaultProps)var ye=S.type.defaultProps;for(Pe in A)ie.call(A,Pe)&&!Z.hasOwnProperty(Pe)&&(ue[Pe]=A[Pe]===void 0&&ye!==void 0?ye[Pe]:A[Pe])}var Pe=arguments.length-2;if(Pe===1)ue.children=se;else if(1<Pe){ye=Array(Pe);for(var Ct=0;Ct<Pe;Ct++)ye[Ct]=arguments[Ct+2];ue.children=ye}return{$$typeof:r,type:S.type,key:pe,ref:me,props:ue,_owner:Ee}},oe.createContext=function(S){return S={$$typeof:u,_currentValue:S,_currentValue2:S,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},S.Provider={$$typeof:c,_context:S},S.Consumer=S},oe.createElement=ce,oe.createFactory=function(S){var A=ce.bind(null,S);return A.type=S,A},oe.createRef=function(){return{current:null}},oe.forwardRef=function(S){return{$$typeof:f,render:S}},oe.isValidElement=fe,oe.lazy=function(S){return{$$typeof:v,_payload:{_status:-1,_result:S},_init:pt}},oe.memo=function(S,A){return{$$typeof:g,type:S,compare:A===void 0?null:A}},oe.startTransition=function(S){var A=W.transition;W.transition={};try{S()}finally{W.transition=A}},oe.unstable_act=H,oe.useCallback=function(S,A){return De.current.useCallback(S,A)},oe.useContext=function(S){return De.current.useContext(S)},oe.useDebugValue=function(){},oe.useDeferredValue=function(S){return De.current.useDeferredValue(S)},oe.useEffect=function(S,A){return De.current.useEffect(S,A)},oe.useId=function(){return De.current.useId()},oe.useImperativeHandle=function(S,A,se){return De.current.useImperativeHandle(S,A,se)},oe.useInsertionEffect=function(S,A){return De.current.useInsertionEffect(S,A)},oe.useLayoutEffect=function(S,A){return De.current.useLayoutEffect(S,A)},oe.useMemo=function(S,A){return De.current.useMemo(S,A)},oe.useReducer=function(S,A,se){return De.current.useReducer(S,A,se)},oe.useRef=function(S){return De.current.useRef(S)},oe.useState=function(S){return De.current.useState(S)},oe.useSyncExternalStore=function(S,A,se){return De.current.useSyncExternalStore(S,A,se)},oe.useTransition=function(){return De.current.useTransition()},oe.version="18.3.1",oe}var Rp;function zu(){return Rp||(Rp=1,qc.exports=r0()),qc.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Pp;function i0(){if(Pp)return as;Pp=1;var r=zu(),e=Symbol.for("react.element"),n=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,l=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,c={key:!0,ref:!0,__self:!0,__source:!0};function u(f,p,g){var v,x={},y=null,N=null;g!==void 0&&(y=""+g),p.key!==void 0&&(y=""+p.key),p.ref!==void 0&&(N=p.ref);for(v in p)s.call(p,v)&&!c.hasOwnProperty(v)&&(x[v]=p[v]);if(f&&f.defaultProps)for(v in p=f.defaultProps,p)x[v]===void 0&&(x[v]=p[v]);return{$$typeof:e,type:f,key:y,ref:N,props:x,_owner:l.current}}return as.Fragment=n,as.jsx=u,as.jsxs=u,as}var Ap;function s0(){return Ap||(Ap=1,Qc.exports=i0()),Qc.exports}var _=s0(),ne=zu();const Qm=Km(ne);var tl={},Yc={exports:{}},wt={},Xc={exports:{}},Jc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var bp;function o0(){return bp||(bp=1,(function(r){function e(W,X){var H=W.length;W.push(X);e:for(;0<H;){var S=H-1>>>1,A=W[S];if(0<l(A,X))W[S]=X,W[H]=A,H=S;else break e}}function n(W){return W.length===0?null:W[0]}function s(W){if(W.length===0)return null;var X=W[0],H=W.pop();if(H!==X){W[0]=H;e:for(var S=0,A=W.length,se=A>>>1;S<se;){var ue=2*(S+1)-1,pe=W[ue],me=ue+1,Ee=W[me];if(0>l(pe,H))me<A&&0>l(Ee,pe)?(W[S]=Ee,W[me]=H,S=me):(W[S]=pe,W[ue]=H,S=ue);else if(me<A&&0>l(Ee,H))W[S]=Ee,W[me]=H,S=me;else break e}}return X}function l(W,X){var H=W.sortIndex-X.sortIndex;return H!==0?H:W.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var u=Date,f=u.now();r.unstable_now=function(){return u.now()-f}}var p=[],g=[],v=1,x=null,y=3,N=!1,R=!1,F=!1,z=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function j(W){for(var X=n(g);X!==null;){if(X.callback===null)s(g);else if(X.startTime<=W)s(g),X.sortIndex=X.expirationTime,e(p,X);else break;X=n(g)}}function Q(W){if(F=!1,j(W),!R)if(n(p)!==null)R=!0,pt(ie);else{var X=n(g);X!==null&&De(Q,X.startTime-W)}}function ie(W,X){R=!1,F&&(F=!1,L(ce),ce=-1),N=!0;var H=y;try{for(j(X),x=n(p);x!==null&&(!(x.expirationTime>X)||W&&!Re());){var S=x.callback;if(typeof S=="function"){x.callback=null,y=x.priorityLevel;var A=S(x.expirationTime<=X);X=r.unstable_now(),typeof A=="function"?x.callback=A:x===n(p)&&s(p),j(X)}else s(p);x=n(p)}if(x!==null)var se=!0;else{var ue=n(g);ue!==null&&De(Q,ue.startTime-X),se=!1}return se}finally{x=null,y=H,N=!1}}var re=!1,Z=null,ce=-1,we=5,fe=-1;function Re(){return!(r.unstable_now()-fe<we)}function We(){if(Z!==null){var W=r.unstable_now();fe=W;var X=!0;try{X=Z(!0,W)}finally{X?rt():(re=!1,Z=null)}}else re=!1}var rt;if(typeof U=="function")rt=function(){U(We)};else if(typeof MessageChannel<"u"){var Mt=new MessageChannel,qt=Mt.port2;Mt.port1.onmessage=We,rt=function(){qt.postMessage(null)}}else rt=function(){z(We,0)};function pt(W){Z=W,re||(re=!0,rt())}function De(W,X){ce=z(function(){W(r.unstable_now())},X)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(W){W.callback=null},r.unstable_continueExecution=function(){R||N||(R=!0,pt(ie))},r.unstable_forceFrameRate=function(W){0>W||125<W?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):we=0<W?Math.floor(1e3/W):5},r.unstable_getCurrentPriorityLevel=function(){return y},r.unstable_getFirstCallbackNode=function(){return n(p)},r.unstable_next=function(W){switch(y){case 1:case 2:case 3:var X=3;break;default:X=y}var H=y;y=X;try{return W()}finally{y=H}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(W,X){switch(W){case 1:case 2:case 3:case 4:case 5:break;default:W=3}var H=y;y=W;try{return X()}finally{y=H}},r.unstable_scheduleCallback=function(W,X,H){var S=r.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?S+H:S):H=S,W){case 1:var A=-1;break;case 2:A=250;break;case 5:A=1073741823;break;case 4:A=1e4;break;default:A=5e3}return A=H+A,W={id:v++,callback:X,priorityLevel:W,startTime:H,expirationTime:A,sortIndex:-1},H>S?(W.sortIndex=H,e(g,W),n(p)===null&&W===n(g)&&(F?(L(ce),ce=-1):F=!0,De(Q,H-S))):(W.sortIndex=A,e(p,W),R||N||(R=!0,pt(ie))),W},r.unstable_shouldYield=Re,r.unstable_wrapCallback=function(W){var X=y;return function(){var H=y;y=X;try{return W.apply(this,arguments)}finally{y=H}}}})(Jc)),Jc}var Op;function l0(){return Op||(Op=1,Xc.exports=o0()),Xc.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Dp;function a0(){if(Dp)return wt;Dp=1;var r=zu(),e=l0();function n(t){for(var i="https://reactjs.org/docs/error-decoder.html?invariant="+t,o=1;o<arguments.length;o++)i+="&args[]="+encodeURIComponent(arguments[o]);return"Minified React error #"+t+"; visit "+i+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var s=new Set,l={};function c(t,i){u(t,i),u(t+"Capture",i)}function u(t,i){for(l[t]=i,t=0;t<i.length;t++)s.add(i[t])}var f=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),p=Object.prototype.hasOwnProperty,g=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,v={},x={};function y(t){return p.call(x,t)?!0:p.call(v,t)?!1:g.test(t)?x[t]=!0:(v[t]=!0,!1)}function N(t,i,o,a){if(o!==null&&o.type===0)return!1;switch(typeof i){case"function":case"symbol":return!0;case"boolean":return a?!1:o!==null?!o.acceptsBooleans:(t=t.toLowerCase().slice(0,5),t!=="data-"&&t!=="aria-");default:return!1}}function R(t,i,o,a){if(i===null||typeof i>"u"||N(t,i,o,a))return!0;if(a)return!1;if(o!==null)switch(o.type){case 3:return!i;case 4:return i===!1;case 5:return isNaN(i);case 6:return isNaN(i)||1>i}return!1}function F(t,i,o,a,d,h,m){this.acceptsBooleans=i===2||i===3||i===4,this.attributeName=a,this.attributeNamespace=d,this.mustUseProperty=o,this.propertyName=t,this.type=i,this.sanitizeURL=h,this.removeEmptyString=m}var z={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(t){z[t]=new F(t,0,!1,t,null,!1,!1)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(t){var i=t[0];z[i]=new F(i,1,!1,t[1],null,!1,!1)}),["contentEditable","draggable","spellCheck","value"].forEach(function(t){z[t]=new F(t,2,!1,t.toLowerCase(),null,!1,!1)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(t){z[t]=new F(t,2,!1,t,null,!1,!1)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(t){z[t]=new F(t,3,!1,t.toLowerCase(),null,!1,!1)}),["checked","multiple","muted","selected"].forEach(function(t){z[t]=new F(t,3,!0,t,null,!1,!1)}),["capture","download"].forEach(function(t){z[t]=new F(t,4,!1,t,null,!1,!1)}),["cols","rows","size","span"].forEach(function(t){z[t]=new F(t,6,!1,t,null,!1,!1)}),["rowSpan","start"].forEach(function(t){z[t]=new F(t,5,!1,t.toLowerCase(),null,!1,!1)});var L=/[\-:]([a-z])/g;function U(t){return t[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(t){var i=t.replace(L,U);z[i]=new F(i,1,!1,t,null,!1,!1)}),"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(t){var i=t.replace(L,U);z[i]=new F(i,1,!1,t,"http://www.w3.org/1999/xlink",!1,!1)}),["xml:base","xml:lang","xml:space"].forEach(function(t){var i=t.replace(L,U);z[i]=new F(i,1,!1,t,"http://www.w3.org/XML/1998/namespace",!1,!1)}),["tabIndex","crossOrigin"].forEach(function(t){z[t]=new F(t,1,!1,t.toLowerCase(),null,!1,!1)}),z.xlinkHref=new F("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1),["src","href","action","formAction"].forEach(function(t){z[t]=new F(t,1,!1,t.toLowerCase(),null,!0,!0)});function j(t,i,o,a){var d=z.hasOwnProperty(i)?z[i]:null;(d!==null?d.type!==0:a||!(2<i.length)||i[0]!=="o"&&i[0]!=="O"||i[1]!=="n"&&i[1]!=="N")&&(R(i,o,d,a)&&(o=null),a||d===null?y(i)&&(o===null?t.removeAttribute(i):t.setAttribute(i,""+o)):d.mustUseProperty?t[d.propertyName]=o===null?d.type===3?!1:"":o:(i=d.attributeName,a=d.attributeNamespace,o===null?t.removeAttribute(i):(d=d.type,o=d===3||d===4&&o===!0?"":""+o,a?t.setAttributeNS(a,i,o):t.setAttribute(i,o))))}var Q=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,ie=Symbol.for("react.element"),re=Symbol.for("react.portal"),Z=Symbol.for("react.fragment"),ce=Symbol.for("react.strict_mode"),we=Symbol.for("react.profiler"),fe=Symbol.for("react.provider"),Re=Symbol.for("react.context"),We=Symbol.for("react.forward_ref"),rt=Symbol.for("react.suspense"),Mt=Symbol.for("react.suspense_list"),qt=Symbol.for("react.memo"),pt=Symbol.for("react.lazy"),De=Symbol.for("react.offscreen"),W=Symbol.iterator;function X(t){return t===null||typeof t!="object"?null:(t=W&&t[W]||t["@@iterator"],typeof t=="function"?t:null)}var H=Object.assign,S;function A(t){if(S===void 0)try{throw Error()}catch(o){var i=o.stack.trim().match(/\n( *(at )?)/);S=i&&i[1]||""}return`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const M=function(r,e){if(!r)throw mi(e)},mi=function(r){return new Error("Firebase Database ("+qm.SDK_VERSION+") INTERNAL ASSERT FAILED: "+r)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
</defs>`,R.innerText="Preview backend running in this workspace."),R.setAttribute("id",N)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",x):x()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gl=new Hu("@firebase/auth");function Zw(r,...e){gl.logLevel<=xe.WARN&&gl.warn(`Auth (${yi}): ${r}`,...e)}function ol(r,...e){gl.logLevel<=xe.ERROR&&gl.error(`Auth (${yi}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ri{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){te(e.idToken,"internal-error"),te(typeof e.idToken<"u","internal-error"),te(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):qp(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}updateFromIdToken(e){te(e.length!==0,"internal-error");const n=qp(e);this.updateTokensAndExpiration(e,null,n)}async getToken(e,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(te(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:s,refreshToken:l,expiresIn:c}=await fx(e,n);this.updateTokensAndExpiration(s,l,Number(c))}updateTokensAndExpiration(e,n,s){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,n){const{refreshToken:s,accessToken:l,expirationTime:c}=n,u=new ri;return s&&(te(typeof s=="string","internal-error",{appName:e}),u.refreshToken=s),l&&(te(typeof l=="string","internal-error",{appName:e}),u.accessToken=l),c&&(te(typeof c=="number","internal-error",{appName:e}),u.expirationTime=c),u}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new ri,this.toJSON())}_performRefresh(){return fn("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wn(r,e){te(typeof r=="string"||typeof r>"u","internal-error",{appName:e})}class Gt{constructor({uid:e,auth:n,stsTokenManager:s,...l}){this.providerId="firebase",this.proactiveRefresh=new ux(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=e,this.auth=n,this.stsTokenManager=s,this.accessToken=s.accessToken,this.displayName=l.displayName||null,this.email=l.email||null,this.emailVerified=l.emailVerified||!1,this.phoneNumber=l.phoneNumber||null,this.photoURL=l.photoURL||null,this.isAnonymous=l.isAnonymous||!1,this.tenantId=l.tenantId||null,this.providerData=l.providerData?[...l.providerData]:[],this.metadata=new Cu(l.createdAt||void 0,l.lastLoginAt||void 0)}async getIdToken(e){const n=await Cs(this,this.stsTokenManager.getToken(this.auth,e));return te(n,this.auth,"internal-error"),this.accessToken!==n&&(this.accessToken=n,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),n}getIdTokenResult(e){return ax(this,e)}reload(){return dx(this)}_assign(e){this!==e&&(te(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(n=>({...n})),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const n=new Gt({...this,auth:e,stsTokenManager:this.stsTokenManager._clone()});return n.metadata._copy(this.metadata),n}_onReload(e){te(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,n=!1){let s=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),s=!0),n&&await yl(this),await this.auth._persistUserIfCurrent(this),s&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(Ht(this.auth.app))return Promise.reject(Yn(this.auth));const e=await this.getIdToken();return await Cs(this,lx(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return{uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>({...e})),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId,...this.metadata.toJSON(),apiKey:this.auth.config.apiKey,appName:this.auth.name}}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,n){const s=n.displayName??void 0,l=n.email??void 0,c=n.phoneNumber??void 0,u=n.photoURL??void 0,f=n.tenantId??void 0,p=n._redirectEventId??void 0,g=n.createdAt??void 0,v=n.lastLoginAt??void 0,{uid:x,emailVerified:y,isAnonymous:N,providerData:R,stsTokenManager:F}=n;te(x&&F,e,"internal-error");const z=ri.fromJSON(this.name,F);te(typeof x=="string",e,"internal-error"),Wn(s,e.name),Wn(l,e.name),te(typeof y=="boolean",e,"internal-error"),te(typeof N=="boolean",e,"internal-error"),Wn(c,e.name),Wn(u,e.name),Wn(f,e.name),Wn(p,e.name),Wn(g,e.name),Wn(v,e.name);const L=new Gt({uid:x,auth:e,email:l,emailVerified:y,displayName:s,isAnonymous:N,photoURL:u,phoneNumber:c,tenantId:f,stsTokenManager:z,createdAt:g,lastLoginAt:v});return R&&Array.isArray(R)&&(L.providerData=R.map(U=>({...U}))),p&&(L._redirectEventId=p),L}static async _fromIdTokenResponse(e,n,s=!1){const l=new ri;l.updateFromServerResponse(n);const c=new Gt({uid:n.localId,auth:e,stsTokenManager:l,isAnonymous:s});return await yl(c),c}static async _fromGetAccountInfoResponse(e,n,s){const l=n.users[0];te(l.localId!==void 0,"internal-error");const c=l.providerUserInfo!==void 0?vg(l.providerUserInfo):[],u=!(l.email&&l.passwordHash)&&!(c!=null&&c.length),f=new ri;f.updateFromIdToken(s);const p=new Gt({uid:l.localId,auth:e,stsTokenManager:f,isAnonymous:u}),g={uid:l.localId,displayName:l.displayName||null,photoURL:l.photoUrl||null,email:l.email||null,emailVerified:l.emailVerified||!1,phoneNumber:l.phoneNumber||null,tenantId:l.tenantId||null,providerData:c,metadata:new Cu(l.createdAt,l.lastLoginAt),isAnonymous:!(l.email&&l.passwordHash)&&!(c!=null&&c.length)};return Object.assign(p,g),p}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kx(r,e){const n=Gu(r,"auth");if(n.isInitialized()){const l=n.getImmediate(),c=n.getOptions();if(xr(c,e??{}))return l;yn(l,"already-initialized")}return n.initialize({options:e})}function Nx(r,e){const n=(e==null?void 0:e.persistence)||[],s=(Array.isArray(n)?n:[n]).map(pn);e!=null&&e.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function Tx(r,e,n){const s=Ul(r);te(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const l=!1,c=Pg(e),{host:u,port:f}=Rx(e),p=f===null?"":`:${f}`,g={url:`${c}//${u}${p}/`},v=Object.freeze({host:u,port:f,protocol:c.replace(":",""),options:Object.freeze({disableWarnings:l})});if(!s._canInitEmulator){te(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),te(xr(g,s.config.emulator)&&xr(v,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=g,s.emulatorConfig=v,s.settings.appVerificationDisabledForTesting=!0,gi(u)?(ng(`${c}//${u}${p}`),rg("Auth",!0)):Px()}function Pg(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function Rx(r){const e=Pg(r),n=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!n)return{host:"",port:null};const s=n[2].split("@").pop()||"",l=/^(\[[^\]]+\])(:|$)/.exec(s);if(l){const c=l[1];return{host:c,port:em(s.substr(c.length+1))}}else{const[c,u]=s.split(":");return{host:c,port:em(u)}}}function em(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function Px(){function r(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Lx(r,e,n=!1){const{auth:s}=r;if(Ht(s.app))return Promise.reject(Yn(s));const l="reauthenticate";try{const c=await Cs(r,Og(s,l,e,r),n);te(c.idToken,s,"internal-error");const u=qu(c.idToken);te(u,s,"internal-error");const{sub:f}=u;return te(r.uid===f,s,"user-mismatch"),Zn._forOperation(r,l,c)}catch(c){throw(c==null?void 0:c.code)==="auth/user-not-found"&&yn(s,"user-mismatch"),c}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hx{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,n,s=50){const l=typeof MessageChannel<"u"?new MessageChannel:null;if(!l)throw new Error("connection_unavailable");let c,u;return new Promise((f,p)=>{const g=Ju("",20);l.port1.start();const v=setTimeout(()=>{p(new Error("unsupported_event"))},s);u={messageChannel:l,onMessage(x){const y=x;if(y.data.eventId===g)switch(y.data.status){case"ack":clearTimeout(v),c=setTimeout(()=>{p(new Error("timeout"))},3e3);break;case"done":clearTimeout(c),f(y.data.response);break;default:clearTimeout(v),clearTimeout(c),p(new Error("invalid_response"));break}}},this.handlers.add(u),l.port1.addEventListener("message",u.onMessage),this.target.postMessage({eventType:e,eventId:g,data:n},[l.port2])}).finally(()=>{u&&this.removeMessageHandler(u)})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tC(r,e){return e?pn(e):(te(r._popupRedirectResolver,r,"argument-error"),r._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const SC=new Ds(5e3,15e3),IC="__/auth/iframe",kC="emulator/auth/iframe",NC={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},TC=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function RC(r){const e=r.config;te(e.authDomain,r,"auth-domain-config-required");const n=e.emulator?Qu(e,kC):`https://${r.config.authDomain}/${IC}`,s={apiKey:e.apiKey,appName:r.name,v:yi},l=TC.get(r.config.apiHost);l&&(s.eid=l);const c=r._getFrameworks();return c.length&&(s.fw=c.join(",")),`${n}?${_i(s).slice(1)}`}async function PC(r){const e=await EC(r),n=nn().gapi;return te(n,r,"internal-error"),e.open({where:document.body,url:RC(r),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:NC,dontclear:!0},s=>new Promise(async(l,c)=>{await s.restyle({setHideOnLeave:!1});const u=tn(r,"network-request-failed"),f=nn().setTimeout(()=>{c(u)},SC.get());function p(){nn().clearTimeout(f),l(s)}s.ping(p).then(p,()=>{c(u)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FC="__/auth/handler",UC="emulator/auth/handler",zC=encodeURIComponent("fac");async function lm(r,e,n,s,l,c){te(r.config.authDomain,r,"auth-domain-config-required"),te(r.config.apiKey,r,"invalid-api-key");const u={apiKey:r.config.apiKey,appName:r.name,authType:n,redirectUrl:s,v:yi,eventId:l};if(e instanceof bg){e.setDefaultLanguage(r.languageCode),u.providerId=e.providerId||"",mu(e.getCustomParameters())||(u.customParameters=JSON.stringify(e.getCustomParameters()));for(const[v,x]of Object.entries({}))u[v]=x}if(e instanceof Ls){const v=e.getScopes().filter(x=>x!=="");v.length>0&&(u.scopes=v.join(","))}r.tenantId&&(u.tid=r.tenantId);const f=u;for(const v of Object.keys(f))f[v]===void 0&&delete f[v];const p=await r._getAppCheckToken(),g=p?`#${zC}=${encodeURIComponent(p)}`:"";return`${WC(r)}?${_i(f).slice(1)}${g}`}function WC({config:r}){return r.emulator?Qu(r,UC):`https://${r.authDomain}/${FC}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const su="webStorageSupport";class VC{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=jg,this._completeRedirectFn=hC,this._overrideRedirectResult=cC}async _openPopup(e,n,s,l){var u;vn((u=this.eventManagers[e._key()])==null?void 0:u.manager,"_initialize() not called before _openPopup()");const c=await lm(e,n,s,xu(),l);return MC(e,c,Ju())}async _openRedirect(e,n,s,l){await this._originValidation(e);const c=await lm(e,n,s,xu(),l);return $x(c),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:l,promise:c}=this.eventManagers[n];return l?Promise.resolve(l):(vn(c,"If manager is not set, promise should be"),c)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await PC(e),s=new pC(e);return n.register("authEvent",l=>(te(l==null?void 0:l.authEvent,e,"invalid-auth-event"),{status:s.onEvent(l.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(su,{type:su},l=>{var u;const c=(u=l==null?void 0:l[0])==null?void 0:u[su];c!==void 0&&n(!!c),yn(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=vC(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return Tg()||Cg()||Yu()}}const BC=VC;var am="@firebase/auth",cm="1.12.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mE{constructor(e,n,s){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=s,this.auth_=null,this.auth_=s.getImmediate({optional:!0}),this.auth_||s.onInit(l=>this.auth_=l)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(Ze("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,s)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,s):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',dt(e)}}class ul{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}ul.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class h_{constructor(e){this.allowedEvents_=e,this.listeners_={},M(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const s=[...this.listeners_[e]];for(let l=0;l<s.length;l++)s[l].callback.apply(s[l].context,n)}}on(e,n,s){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:s});const l=this.getInitialEvent(e);l&&n.apply(s,l)}off(e,n,s){this.validateEventType_(e);const l=this.listeners_[e]||[];for(let c=0;c<l.length;c++)if(l[c].callback===n&&(!s||s===l[c].context)){l.splice(c,1);return}}validateEventType_(e){M(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class El extends h_{static getInstance(){return new El}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Bu()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return M(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vl{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const s=new ae(ui,e),l=new ae(ui,n);return this.compare(s,l)!==0}minPost(){return ae.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ku;function JE(r){ku=r}const g_=function(r){return typeof r=="number"?"number:"+Qg(r):"string:"+r},__=function(r){if(r.isLeafNode()){const e=r.val();M(typeof e=="string"||typeof e=="number"||typeof e=="object"&&rn(e,".sv"),"Priority must be a string or number.")}else M(r===ku||r.isEmpty(),"priority of unexpected type.");M(r===ku||r.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Nm;class qe{static set __childrenNodeConstructor(e){Nm=e}static get __childrenNodeConstructor(){return Nm}constructor(e,n=qe.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=n,this.lazyHash_=null,M(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),__(this.priorityNode_)}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new qe(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:qe.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return de(e)?this:le(e)===".priority"?this.priorityNode_:qe.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,n){return null}updateImmediateChild(e,n){return e===".priority"?this.updatePriority(n):n.isEmpty()&&e!==".priority"?this:qe.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}updateChild(e,n){const s=le(e);return s===null?n:n.isEmpty()&&s!==".priority"?this:(M(s!==".priority"||er(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(s,qe.__childrenNodeConstructor.EMPTY_NODE.updateChild(ke(e),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,n){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+g_(this.priorityNode_.val())+":");const n=typeof this.value_;e+=n+":",n==="number"?e+=Qg(this.value_):e+=this.value_,this.lazyHash_=Gg(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===qe.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof qe.__childrenNodeConstructor?-1:(M(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const n=typeof e.value_,s=typeof this.value_,l=qe.VALUE_TYPE_ORDER.indexOf(n),c=qe.VALUE_TYPE_ORDER.indexOf(s);return M(l>=0,"Unknown leaf type: "+n),M(c>=0,"Unknown leaf type: "+s),l===c?s==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:c-l}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const n=e;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}qe.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nS=Math.log(2);class rS{constructor(e){const n=c=>parseInt(Math.log(c)/nS,10),s=c=>parseInt(Array(c+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const l=s(this.count);this.bits_=e+1&l}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Sl=function(r,e,n,s){r.sort(e);const l=function(p,g){const v=g-p;let x,y;if(v===0)return null;if(v===1)return x=r[p],y=n?n(x):x,new Ye(y,x.node,Ye.BLACK,null,null);{const N=parseInt(v/2,10)+p,R=l(p,N),F=l(N+1,g);return x=r[N],y=n?n(x):x,new Ye(y,x.node,Ye.BLACK,R,F)}},c=function(p){let g=null,v=null,x=r.length;const y=function(R,F){const z=x-R,L=x;x-=R;const U=l(z+1,L),j=r[z],Q=n?n(j):j;N(new Ye(Q,j.node,F,null,U))},N=function(R){g?(g.left=R,g=R):(v=R,g=R)};for(let R=0;R<p.count;++R){const F=p.nextBitIsOne(),z=Math.pow(2,p.count-(R+1));F?y(z,Ye.BLACK):(y(z,Ye.BLACK),y(z,Ye.RED))}return v},u=new rS(r.length),f=c(u);return new xt(s||e,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cu;const ei={};class mn{static get Default(){return M(ei&&je,"ChildrenNode.ts has not been loaded"),cu=cu||new mn({".priority":ei},{".priority":je}),cu}constructor(e,n){this.indexes_=e,this.indexSet_=n}get(e){const n=ai(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof xt?n:null}hasIndex(e){return rn(this.indexSet_,e.toString())}addIndex(e,n){M(e!==li,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let l=!1;const c=n.getIterator(ae.Wrap);let u=c.getNext();for(;u;)l=l||e.isDefinedOn(u.node),s.push(u),u=c.getNext();let f;l?f=Sl(s,e.getCompare()):f=ei;const p=e.toString(),g={...this.indexSet_};g[p]=e;const v={...this.indexes_};return v[p]=f,new mn(v,g)}addToIndexes(e,n){const s=pl(this.indexes_,(l,c)=>{const u=ai(this.indexSet_,c);if(M(u,"Missing index implementation for "+c),l===ei)if(u.isDefinedOn(e.node)){const f=[],p=n.getIterator(ae.Wrap);let g=p.getNext();for(;g;)g.name!==e.name&&f.push(g),g=p.getNext();return f.push(e),Sl(f,u.getCompare())}else return ei;else{const f=n.get(e.name);let p=l;return f&&(p=p.remove(new ae(e.name,f))),p.insert(e,e.node)}});return new mn(s,this.indexSet_)}removeFromIndexes(e,n){const s=pl(this.indexes_,l=>{if(l===ei)return l;{const c=n.get(e.name);return c?l.remove(new ae(e.name,c)):l}});return new mn(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sS=!0;function He(r,e=null){if(r===null)return J.EMPTY_NODE;if(typeof r=="object"&&".priority"in r&&(e=r[".priority"]),M(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof r=="object"&&".value"in r&&r[".value"]!==null&&(r=r[".value"]),typeof r!="object"||".sv"in r){const n=r;return new qe(n,He(e))}if(!(r instanceof Array)&&sS){const n=[];let s=!1;if(nt(r,(u,f)=>{if(u.substring(0,1)!=="."){const p=He(f);p.isEmpty()||(s=s||!p.getPriority().isEmpty(),n.push(new ae(u,p)))}}),n.length===0)return J.EMPTY_NODE;const c=Sl(n,XE,u=>u.name,ad);if(s){const u=Sl(n,je.getCompare());return new J(c,He(e),new mn({".priority":u},{".priority":je}))}else return new J(c,He(e),mn.Default)}else{let n=J.EMPTY_NODE;return nt(r,(s,l)=>{if(rn(r,s)&&s.substring(0,1)!=="."){const c=He(l);(c.isLeafNode()||!c.isEmpty())&&(n=n.updateImmediateChild(s,c))}}),n.updatePriority(He(e))}}ZE(He);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oS extends Vl{constructor(e){super(),this.indexPath_=e,M(!de(e)&&le(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const s=this.extractChild(e.node),l=this.extractChild(n.node),c=s.compareTo(l);return c===0?Nr(e.name,n.name):c}makePost(e,n){const s=He(e),l=J.EMPTY_NODE.updateChild(this.indexPath_,s);return new ae(n,l)}maxPost(){const e=J.EMPTY_NODE.updateChild(this.indexPath_,Us);return new ae(Sr,e)}toString(){return Ss(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lS extends Vl{compare(e,n){const s=e.node.compareTo(n.node);return s===0?Nr(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return ae.MIN}maxPost(){return ae.MAX}makePost(e,n){const s=He(e);return new ae(n,s)}toString(){return".value"}}const aS=new lS;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ud{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=je}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return M(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return M(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:ui}hasEnd(){return this.endSet_}getIndexEndValue(){return M(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return M(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:Sr}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return M(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===je}copy(){const e=new ud;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function dS(r){return r.loadsAllData()?new cd(r.getIndex()):r.hasLimit()?new uS(r):new Ns(r)}function Tm(r){const e={};if(r.isDefault())return e;let n;if(r.index_===je?n="$priority":r.index_===aS?n="$value":r.index_===li?n="$key":(M(r.index_ instanceof oS,"Unrecognized index type!"),n=r.index_.toString()),e.orderBy=$e(n),r.startSet_){const s=r.startAfterSet_?"startAfter":"startAt";e[s]=$e(r.indexStartValue_),r.startNameSet_&&(e[s]+=","+$e(r.indexStartName_))}if(r.endSet_){const s=r.endBeforeSet_?"endBefore":"endAt";e[s]=$e(r.indexEndValue_),r.endNameSet_&&(e[s]+=","+$e(r.indexEndName_))}return r.limitSet_&&(r.isViewFromLeft()?e.limitToFirst=r.limit_:e.limitToLast=r.limit_),e}function Rm(r){const e={};if(r.startSet_&&(e.sp=r.indexStartValue_,r.startNameSet_&&(e.sn=r.indexStartName_),e.sin=!r.startAfterSet_),r.endSet_&&(e.ep=r.indexEndValue_,r.endNameSet_&&(e.en=r.indexEndName_),e.ein=!r.endBeforeSet_),r.limitSet_){e.l=r.limit_;let n=r.viewFrom_;n===""&&(r.isViewFromLeft()?n="l":n="r"),e.vf=n}return r.index_!==je&&(e.i=r.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kl(){return{value:null,children:new Map}}function x_(r,e,n){if(de(e))r.value=n,r.children.clear();else if(r.value!==null)r.value=r.value.updateChild(e,n);else{const s=le(e);r.children.has(s)||r.children.set(s,kl());const l=r.children.get(s);e=ke(e),x_(l,e,n)}}function Nu(r,e,n){r.value!==null?n(e,r.value):fS(r,(s,l)=>{const c=new Ce(e.toString()+"/"+s);Nu(l,c,n)})}function fS(r,e){r.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pS{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n={...e};return this.last_&&nt(this.last_,(s,l)=>{n[s]=n[s]-l}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pm=10*1e3,mS=30*1e3,gS=300*1e3;class _S{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new pS(e);const s=Pm+(mS-Pm)*Math.random();gs(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;nt(e,(l,c)=>{c>0&&rn(this.statsToReport_,l)&&(n[l]=c,s=!0)}),s&&this.server_.reportStats(n),gs(this.reportStats_.bind(this),Math.floor(Math.random()*2*gS))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ts{constructor(e,n){this.source=e,this.path=n,this.type=Kt.LISTEN_COMPLETE}operationForChild(e){return de(this.path)?new Ts(this.source,_e()):new Ts(this.source,ke(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ir{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=Kt.OVERWRITE}operationForChild(e){return de(this.path)?new Ir(this.source,_e(),this.snap.getImmediateChild(e)):new Ir(this.source,ke(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hi{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=Kt.MERGE}operationForChild(e){if(de(this.path)){const n=this.children.subtree(new Ce(e));return n.isEmpty()?null:n.value?new Ir(this.source,_e(),n.value):new hi(this.source,_e(),n)}else return M(le(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new hi(this.source,ke(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hl(r,e){return N_(e,r)}function ES(r,e,n,s,l){M(s>r.lastWriteId,"Stacking an older write on top of newer ones"),l===void 0&&(l=!0),r.allWrites.push({path:e,snap:n,writeId:s,visible:l}),l&&(r.visibleWrites=ys(r.visibleWrites,e,n)),r.lastWriteId=s}function SS(r,e,n,s){M(s>r.lastWriteId,"Stacking an older merge on top of newer ones"),r.allWrites.push({path:e,children:n,writeId:s,visible:!0}),r.visibleWrites=Tu(r.visibleWrites,e,n),r.lastWriteId=s}function IS(r,e){for(let n=0;n<r.allWrites.length;n++){const s=r.allWrites[n];if(s.writeId===e)return s}return null}function kS(r,e){const n=r.allWrites.findIndex(f=>f.writeId===e);M(n>=0,"removeWrite called with nonexistent writeId.");const s=r.allWrites[n];r.allWrites.splice(n,1);let l=s.visible,c=!1,u=r.allWrites.length-1;for(;l&&u>=0;){const f=r.allWrites[u];f.visible&&(u>=n&&NS(f,s.path)?l=!1:Dt(s.path,f.path)&&(c=!0)),u--}if(l){if(c)return TS(r),!0;if(s.snap)r.visibleWrites=Am(r.visibleWrites,s.path);else{const f=s.children;nt(f,p=>{r.visibleWrites=Am(r.visibleWrites,Me(s.path,p))})}return!0}else return!1}function NS(r,e){if(r.snap)return Dt(r.path,e);for(const n in r.children)if(r.children.hasOwnProperty(n)&&Dt(Me(r.path,n),e))return!0;return!1}function TS(r){r.visibleWrites=S_(r.allWrites,RS,_e()),r.allWrites.length>0?r.lastWriteId=r.allWrites[r.allWrites.length-1].writeId:r.lastWriteId=-1}function RS(r){return r.visible}function S_(r,e,n){let s=Qt.empty();for(let l=0;l<r.length;++l){const c=r[l];if(e(c)){const u=c.path;let f;if(c.snap)Dt(n,u)?(f=ut(n,u),s=ys(s,f,c.snap)):Dt(u,n)&&(f=ut(u,n),s=ys(s,_e(),c.snap.getChild(f)));else if(c.children){if(Dt(n,u))f=ut(n,u),s=Tu(s,f,c.children);else if(Dt(u,n))if(f=ut(u,n),de(f))s=Tu(s,_e(),c.children);else{const p=ai(c.children,le(f));if(p){const g=p.getChild(ke(f));s=ys(s,_e(),g)}}}else throw mi("WriteRecord should have .snap or .children")}}return s}function I_(r,e,n,s,l){if(!s&&!l){const c=Tr(r.visibleWrites,e);if(c!=null)return c;{const u=Xn(r.visibleWrites,e);if(Pu(u))return n;if(n==null&&!Ru(u,_e()))return null;{const f=n||J.EMPTY_NODE;return fi(u,f)}}}else{const c=Xn(r.visibleWrites,e);if(!l&&Pu(c))return n;if(!l&&n==null&&!Ru(c,_e()))return null;{const u=function(g){return(g.visible||l)&&(!s||!~s.indexOf(g.writeId))&&(Dt(g.path,e)||Dt(e,g.path))},f=S_(r.allWrites,u,e),p=n||J.EMPTY_NODE;return fi(f,p)}}}function PS(r,e,n){let s=J.EMPTY_NODE;const l=Tr(r.visibleWrites,e);if(l)return l.isLeafNode()||l.forEachChild(je,(c,u)=>{s=s.updateImmediateChild(c,u)}),s;if(n){const c=Xn(r.visibleWrites,e);return n.forEachChild(je,(u,f)=>{const p=fi(Xn(c,new Ce(u)),f);s=s.updateImmediateChild(u,p)}),bm(c).forEach(u=>{s=s.updateImmediateChild(u.name,u.node)}),s}else{const c=Xn(r.visibleWrites,e);return bm(c).forEach(u=>{s=s.updateImmediateChild(u.name,u.node)}),s}}function AS(r,e,n,s,l){M(s||l,"Either existingEventSnap or existingServerSnap must exist");const c=Me(e,n);if(Ru(r.visibleWrites,c))return null;{const u=Xn(r.visibleWrites,c);return Pu(u)?l.getChild(n):fi(u,l.getChild(n))}}function bS(r,e,n,s){const l=Me(e,n),c=Tr(r.visibleWrites,l);if(c!=null)return c;if(s.isCompleteForChild(n)){const u=Xn(r.visibleWrites,l);return fi(u,s.getNode().getImmediateChild(n))}else return null}function OS(r,e){return Tr(r.visibleWrites,e)}function DS(r,e,n,s,l,c,u){let f;const p=Xn(r.visibleWrites,e),g=Tr(p,_e());if(g!=null)f=g;else if(n!=null)f=fi(p,n);else return[];if(f=f.withIndex(u),!f.isEmpty()&&!f.isLeafNode()){const v=[],x=u.getCompare(),y=c?f.getReverseIteratorFrom(s,u):f.getIteratorFrom(s,u);let N=y.getNext();for(;N&&v.length<l;)x(N,s)!==0&&v.push(N),N=y.getNext();return v}else return[]}function LS(){return{visibleWrites:Qt.empty(),allWrites:[],lastWriteId:-1}}function Rl(r,e,n,s){return I_(r.writeTree,r.treePath,e,n,s)}function pd(r,e){return PS(r.writeTree,r.treePath,e)}function Om(r,e,n,s){return AS(r.writeTree,r.treePath,e,n,s)}function Pl(r,e){return OS(r.writeTree,Me(r.treePath,e))}function MS(r,e,n,s,l,c){return DS(r.writeTree,r.treePath,e,n,s,l,c)}function md(r,e,n){return bS(r.writeTree,r.treePath,e,n)}function k_(r,e){return N_(Me(r.treePath,e),r.writeTree)}function N_(r,e){return{treePath:r,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jS{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,s=e.childName;M(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),M(s!==".priority","Only non-priority child changes can be tracked.");const l=this.changeMap.get(s);if(l){const c=l.type;if(n==="child_added"&&c==="child_removed")this.changeMap.set(s,ks(s,e.snapshotNode,l.snapshotNode));else if(n==="child_removed"&&c==="child_added")this.changeMap.delete(s);else if(n==="child_removed"&&c==="child_changed")this.changeMap.set(s,Is(s,l.oldSnap));else if(n==="child_changed"&&c==="child_added")this.changeMap.set(s,di(s,e.snapshotNode));else if(n==="child_changed"&&c==="child_changed")this.changeMap.set(s,ks(s,e.snapshotNode,l.oldSnap));else throw mi("Illegal combination of changes: "+e+" occurred after "+l)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function US(r){return{filter:r}}function zS(r,e){M(e.eventCache.getNode().isIndexed(r.filter.getIndex()),"Event snap not indexed"),M(e.serverCache.getNode().isIndexed(r.filter.getIndex()),"Server snap not indexed")}function WS(r,e,n,s,l){const c=new jS;let u,f;if(n.type===Kt.OVERWRITE){const g=n;g.source.fromUser?u=Au(r,e,g.path,g.snap,s,l,c):(M(g.source.fromServer,"Unknown source."),f=g.source.tagged||e.serverCache.isFiltered()&&!de(g.path),u=Al(r,e,g.path,g.snap,s,l,f,c))}else if(n.type===Kt.MERGE){const g=n;g.source.fromUser?u=BS(r,e,g.path,g.children,s,l,c):(M(g.source.fromServer,"Unknown source."),f=g.source.tagged||e.serverCache.isFiltered(),u=bu(r,e,g.path,g.children,s,l,f,c))}else if(n.type===Kt.ACK_USER_WRITE){const g=n;g.revert?u=GS(r,e,g.path,s,l,c):u=HS(r,e,g.path,g.affectedTree,s,l,c)}else if(n.type===Kt.LISTEN_COMPLETE)u=$S(r,e,n.path,s,c);else throw mi("Unknown operation type: "+n.type);const p=c.getChanges();return VS(e,u,p),{viewCache:u,changes:p}}function VS(r,e,n){const s=e.eventCache;if(s.isFullyInitialized()){const l=s.getNode().isLeafNode()||s.getNode().isEmpty(),c=Tl(r);(n.length>0||!r.eventCache.isFullyInitialized()||l&&!s.getNode().equals(c)||!s.getNode().getPriority().equals(c.getPriority()))&&n.push(w_(Tl(e)))}}function R_(r,e,n,s,l,c){const u=e.eventCache;if(Pl(s,n)!=null)return e;{let f,p;if(de(n))if(M(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const g=kr(e),v=g instanceof J?g:J.EMPTY_NODE,x=pd(s,v);f=r.filter.updateFullNode(e.eventCache.getNode(),x,c)}else{const g=Rl(s,kr(e));f=r.filter.updateFullNode(e.eventCache.getNode(),g,c)}else{const g=le(n);if(g===".priority"){M(er(n)===1,"Can't have a priority with additional path components");const v=u.getNode();p=e.serverCache.getNode();const x=Om(s,n,v,p);x!=null?f=r.filter.updatePriority(v,x):f=u.getNode()}else{const v=ke(n);let x;if(u.isCompleteForChild(g)){p=e.serverCache.getNode();const y=Om(s,n,u.getNode(),p);y!=null?x=u.getNode().getImmediateChild(g).updateChild(v,y):x=u.getNode().getImmediateChild(g)}else x=md(s,g,e.serverCache);x!=null?f=r.filter.updateChild(u.getNode(),g,x,v,l,c):f=u.getNode()}}return _s(e,f,u.isFullyInitialized()||de(n),r.filter.filtersNodes())}}function Al(r,e,n,s,l,c,u,f){const p=e.serverCache;let g;const v=u?r.filter:r.filter.getIndexedFilter();if(de(n))g=v.updateFullNode(p.getNode(),s,null);else if(v.filtersNodes()&&!p.isFiltered()){const N=p.getNode().updateChild(n,s);g=v.updateFullNode(p.getNode(),N,null)}else{const N=le(n);if(!p.isCompleteForPath(n)&&er(n)>1)return e;const R=ke(n),z=p.getNode().getImmediateChild(N).updateChild(R,s);N===".priority"?g=v.updatePriority(p.getNode(),z):g=v.updateChild(p.getNode(),N,z,R,T_,null)}const x=C_(e,g,p.isFullyInitialized()||de(n),v.filtersNodes()),y=new gd(l,x,c);return R_(r,x,n,l,y,f)}function Au(r,e,n,s,l,c,u){const f=e.eventCache;let p,g;const v=new gd(l,e,c);if(de(n))g=r.filter.updateFullNode(e.eventCache.getNode(),s,u),p=_s(e,g,!0,r.filter.filtersNodes());else{const x=le(n);if(x===".priority")g=r.filter.updatePriority(e.eventCache.getNode(),s),p=_s(e,g,f.isFullyInitialized(),f.isFiltered());else{const y=ke(n),N=f.getNode().getImmediateChild(x);let R;if(de(y))R=s;else{const F=v.getCompleteChild(x);F!=null?sd(y)===".priority"&&F.getChild(f_(y)).isEmpty()?R=F:R=F.updateChild(y,s):R=J.EMPTY_NODE}if(N.equals(R))p=e;else{const F=r.filter.updateChild(f.getNode(),x,R,y,v,u);p=_s(e,F,f.isFullyInitialized(),r.filter.filtersNodes())}}}return p}function Dm(r,e){return r.eventCache.isCompleteForChild(e)}function BS(r,e,n,s,l,c,u){let f=e;return s.foreach((p,g)=>{const v=Me(n,p);Dm(e,le(v))&&(f=Au(r,f,v,g,l,c,u))}),s.foreach((p,g)=>{const v=Me(n,p);Dm(e,le(v))||(f=Au(r,f,v,g,l,c,u))}),f}function Lm(r,e,n){return n.foreach((s,l)=>{e=e.updateChild(s,l)}),e}function bu(r,e,n,s,l,c,u,f){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let p=e,g;de(n)?g=s:g=new Ie(null).setTree(n,s);const v=e.serverCache.getNode();return g.children.inorderTraversal((x,y)=>{if(v.hasChild(x)){const N=e.serverCache.getNode().getImmediateChild(x),R=Lm(r,N,y);p=Al(r,p,new Ce(x),R,l,c,u,f)}}),g.children.inorderTraversal((x,y)=>{const N=!e.serverCache.isCompleteForChild(x)&&y.value===null;if(!v.hasChild(x)&&!N){const R=e.serverCache.getNode().getImmediateChild(x),F=Lm(r,R,y);p=Al(r,p,new Ce(x),F,l,c,u,f)}}),p}function HS(r,e,n,s,l,c,u){if(Pl(l,n)!=null)return e;const f=e.serverCache.isFiltered(),p=e.serverCache;if(s.value!=null){if(de(n)&&p.isFullyInitialized()||p.isCompleteForPath(n))return Al(r,e,n,p.getNode().getChild(n),l,c,f,u);if(de(n)){let g=new Ie(null);return p.getNode().forEachChild(li,(v,x)=>{g=g.set(new Ce(v),x)}),bu(r,e,n,g,l,c,f,u)}else return e}else{let g=new Ie(null);return s.foreach((v,x)=>{const y=Me(n,v);p.isCompleteForPath(y)&&(g=g.set(v,p.getNode().getChild(y)))}),bu(r,e,n,g,l,c,f,u)}}function $S(r,e,n,s,l){const c=e.serverCache,u=C_(e,c.getNode(),c.isFullyInitialized()||de(n),c.isFiltered());return R_(r,u,n,s,T_,l)}function GS(r,e,n,s,l,c){let u;if(Pl(s,n)!=null)return e;{const f=new gd(s,e,l),p=e.eventCache.getNode();let g;if(de(n)||le(n)===".priority"){let v;if(e.serverCache.isFullyInitialized())v=Rl(s,kr(e));else{const x=e.serverCache.getNode();M(x instanceof J,"serverChildren would be complete if leaf node"),v=pd(s,x)}v=v,g=r.filter.updateFullNode(p,v,c)}else{const v=le(n);let x=md(s,v,e.serverCache);x==null&&e.serverCache.isCompleteForChild(v)&&(x=p.getImmediateChild(v)),x!=null?g=r.filter.updateChild(p,v,x,ke(n),f,c):e.eventCache.getNode().hasChild(v)?g=r.filter.updateChild(p,v,J.EMPTY_NODE,ke(n),f,c):g=p,g.isEmpty()&&e.serverCache.isFullyInitialized()&&(u=Rl(s,kr(e)),u.isLeafNode()&&(g=r.filter.updateFullNode(g,u,c)))}return u=e.serverCache.isFullyInitialized()||Pl(s,_e())!=null,_s(e,g,u,r.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KS{constructor(e,n){this.query_=e,this.eventRegistrations_=[];const s=this.query_._queryParams,l=new cd(s.getIndex()),c=dS(s);this.processor_=US(c);const u=n.serverCache,f=n.eventCache,p=l.updateFullNode(J.EMPTY_NODE,u.getNode(),null),g=c.updateFullNode(J.EMPTY_NODE,f.getNode(),null),v=new tr(p,u.isFullyInitialized(),l.filtersNodes()),x=new tr(g,f.isFullyInitialized(),c.filtersNodes());this.viewCache_=Bl(x,v),this.eventGenerator_=new yS(this.query_)}get query(){return this.query_}}function QS(r){return r.viewCache_.serverCache.getNode()}function qS(r){return Tl(r.viewCache_)}function YS(r,e){const n=kr(r.viewCache_);return n&&(r.query._queryParams.loadsAllData()||!de(e)&&!n.getImmediateChild(le(e)).isEmpty())?n.getChild(e):null}function Mm(r){return r.eventRegistrations_.length===0}function XS(r,e){r.eventRegistrations_.push(e)}function jm(r,e,n){const s=[];if(n){M(e==null,"A cancel should cancel all event registrations.");const l=r.query._path;r.eventRegistrations_.forEach(c=>{const u=c.createCancelEvent(n,l);u&&s.push(u)})}if(e){let l=[];for(let c=0;c<r.eventRegistrations_.length;++c){const u=r.eventRegistrations_[c];if(!u.matches(e))l.push(u);else if(e.hasAnyCallback()){l=l.concat(r.eventRegistrations_.slice(c+1));break}}r.eventRegistrations_=l}else r.eventRegistrations_=[];return s}function Fm(r,e,n,s){e.type===Kt.MERGE&&e.source.queryId!==null&&(M(kr(r.viewCache_),"We should always have a full cache before handling merges"),M(Tl(r.viewCache_),"Missing event cache, even though we have a server cache"));const l=r.viewCache_,c=WS(r.processor_,l,e,n,s);return zS(r.processor_,c.viewCache),M(c.viewCache.serverCache.isFullyInitialized()||!l.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),r.viewCache_=c.viewCache,P_(r,c.changes,c.viewCache.eventCache.getNode(),null)}function JS(r,e){const n=r.viewCache_.eventCache,s=[];return n.getNode().isLeafNode()||n.getNode().forEachChild(je,(c,u)=>{s.push(di(c,u))}),n.isFullyInitialized()&&s.push(w_(n.getNode())),P_(r,s,n.getNode(),e)}function P_(r,e,n,s){const l=s?[s]:r.eventRegistrations_;return vS(r.eventGenerator_,e,n,l)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ol;function i1(r){M(!Ol,"__referenceConstructor has already been defined"),Ol=r}function s1(){return M(Ol,"Reference.ts has not been loaded"),Ol}let o1=1;class Um{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Ie(null),this.pendingWriteTree_=LS(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function M_(r,e,n,s,l){return ES(r.pendingWriteTree_,e,n,s,l),l?xi(r,new Ir(dd(),e,n)):[]}function l1(r,e,n,s){SS(r.pendingWriteTree_,e,n,s);const l=Ie.fromObject(n);return xi(r,new hi(dd(),e,l))}function Gn(r,e,n=!1){const s=IS(r.pendingWriteTree_,e);if(kS(r.pendingWriteTree_,e)){let c=new Ie(null);return s.snap!=null?c=c.set(_e(),!0):nt(s.children,u=>{c=c.set(new Ce(u),!0)}),xi(r,new Nl(s.path,c,n))}else return[]}function zs(r,e,n){return xi(r,new Ir(hd(),e,n))}function a1(r,e,n){const s=Ie.fromObject(n);return xi(r,new hi(hd(),e,s))}function c1(r,e){return xi(r,new Ts(hd(),e))}function u1(r,e,n){const s=vd(r,n);if(s){const l=wd(s),c=l.path,u=l.queryId,f=ut(c,e),p=new Ts(fd(u),f);return xd(r,c,p)}else return[]}function Dl(r,e,n,s,l=!1){const c=e._path,u=r.syncPointTree_.get(c);let f=[];if(u&&(e._queryIdentifier==="default"||L_(u,e))){const p=r1(u,e,n,s);t1(u)&&(r.syncPointTree_=r.syncPointTree_.remove(c));const g=p.removed;if(f=p.events,!l){const v=g.findIndex(y=>y._queryParams.loadsAllData())!==-1,x=r.syncPointTree_.findOnPath(c,(y,N)=>nr(N));if(v&&!x){const y=r.syncPointTree_.subtree(c);if(!y.isEmpty()){const N=f1(y);for(let R=0;R<N.length;++R){const F=N[R],z=F.query,L=z_(r,F);r.listenProvider_.startListening(vs(z),Rs(r,z),L.hashFn,L.onComplete)}}}!x&&g.length>0&&!s&&(v?r.listenProvider_.stopListening(vs(e),null):g.forEach(y=>{const N=r.queryToTagMap.get(Gl(y));r.listenProvider_.stopListening(vs(y),N)}))}p1(r,g)}return f}function j_(r,e,n,s){const l=vd(r,s);if(l!=null){const c=wd(l),u=c.path,f=c.queryId,p=ut(u,e),g=new Ir(fd(f),p,n);return xd(r,u,g)}else return[]}function d1(r,e,n,s){const l=vd(r,s);if(l){const c=wd(l),u=c.path,f=c.queryId,p=ut(u,e),g=Ie.fromObject(n),v=new hi(fd(f),p,g);return xd(r,u,v)}else return[]}function Ou(r,e,n,s=!1){const l=e._path;let c=null,u=!1;r.syncPointTree_.foreachOnPath(l,(y,N)=>{const R=ut(y,l);c=c||Jn(N,R),u=u||nr(N)});let f=r.syncPointTree_.get(l);f?(u=u||nr(f),c=c||Jn(f,_e())):(f=new A_,r.syncPointTree_=r.syncPointTree_.set(l,f));let p;c!=null?p=!0:(p=!1,c=J.EMPTY_NODE,r.syncPointTree_.subtree(l).foreachChild((N,R)=>{const F=Jn(R,_e());F&&(c=c.updateImmediateChild(N,F))}));const g=L_(f,e);if(!g&&!e._queryParams.loadsAllData()){const y=Gl(e);M(!r.queryToTagMap.has(y),"View does not exist, but we have a tag");const N=m1();r.queryToTagMap.set(y,N),r.tagToQueryMap.set(N,y)}const v=Hl(r.pendingWriteTree_,l);let x=n1(f,e,n,v,c,p);if(!g&&!u&&!s){const y=D_(f,e);x=x.concat(g1(r,e,y))}return x}function yd(r,e,n){const l=r.pendingWriteTree_,c=r.syncPointTree_.findOnPath(e,(u,f)=>{const p=ut(u,e),g=Jn(f,p);if(g)return g});return I_(l,e,c,n,!0)}function h1(r,e){const n=e._path;let s=null;r.syncPointTree_.foreachOnPath(n,(g,v)=>{const x=ut(g,n);s=s||Jn(v,x)});let l=r.syncPointTree_.get(n);l?s=s||Jn(l,_e()):(l=new A_,r.syncPointTree_=r.syncPointTree_.set(n,l));const c=s!=null,u=c?new tr(s,!0,!1):null,f=Hl(r.pendingWriteTree_,e._path),p=b_(l,e,f,c?u.getNode():J.EMPTY_NODE,c);return qS(p)}function xi(r,e){return F_(e,r.syncPointTree_,null,Hl(r.pendingWriteTree_,_e()))}function F_(r,e,n,s){if(de(r.path))return U_(r,e,n,s);{const l=e.get(_e());n==null&&l!=null&&(n=Jn(l,_e()));let c=[];const u=le(r.path),f=r.operationForChild(u),p=e.children.get(u);if(p&&f){const g=n?n.getImmediateChild(u):null,v=k_(s,u);c=c.concat(F_(f,p,g,v))}return l&&(c=c.concat(_d(l,r,s,n))),c}}function U_(r,e,n,s){const l=e.get(_e());n==null&&l!=null&&(n=Jn(l,_e()));let c=[];return e.children.inorderTraversal((u,f)=>{const p=n?n.getImmediateChild(u):null,g=k_(s,u),v=r.operationForChild(u);v&&(c=c.concat(U_(v,f,p,g)))}),l&&(c=c.concat(_d(l,r,s,n))),c}function z_(r,e){const n=e.query,s=Rs(r,n);return{hashFn:()=>(QS(e)||J.EMPTY_NODE).hash(),onComplete:l=>{if(l==="ok")return s?u1(r,n._path,s):c1(r,n._path);{const c=cE(l,n);return Dl(r,n,null,c)}}}}function Rs(r,e){const n=Gl(e);return r.queryToTagMap.get(n)}function Gl(r){return r._path.toString()+"$"+r._queryIdentifier}function vd(r,e){return r.tagToQueryMap.get(e)}function wd(r){const e=r.indexOf("$");return M(e!==-1&&e<r.length-1,"Bad queryKey."),{queryId:r.substr(e+1),path:new Ce(r.substr(0,e))}}function xd(r,e,n){const s=r.syncPointTree_.get(e);M(s,"Missing sync point for query tag that we're tracking");const l=Hl(r.pendingWriteTree_,e);return _d(s,n,l,null)}function f1(r){return r.fold((e,n,s)=>{if(n&&nr(n))return[$l(n)];{let l=[];return n&&(l=O_(n)),nt(s,(c,u)=>{l=l.concat(u)}),l}})}function vs(r){return r._queryParams.loadsAllData()&&!r._queryParams.isDefault()?new(s1())(r._repo,r._path):r}function p1(r,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const l=Gl(s),c=r.queryToTagMap.get(l);r.queryToTagMap.delete(l),r.tagToQueryMap.delete(c)}}}function m1(){return o1++}function g1(r,e,n){const s=e._path,l=Rs(r,e),c=z_(r,n),u=r.listenProvider_.startListening(vs(e),l,c.hashFn,c.onComplete),f=r.syncPointTree_.subtree(s);if(l)M(!nr(f.value),"If we're adding a query, it shouldn't be shadowed");else{const p=f.fold((g,v,x)=>{if(!de(g)&&v&&nr(v))return[$l(v).query];{let y=[];return v&&(y=y.concat(O_(v).map(N=>N.query))),nt(x,(N,R)=>{y=y.concat(R)}),y}});for(let g=0;g<p.length;++g){const v=p[g];r.listenProvider_.stopListening(vs(v),Rs(r,v))}}return u}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class b1{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function ql(r,e){let n=null;for(let s=0;s<e.length;s++){const l=e[s],c=l.getPath();n!==null&&!od(c,n.path)&&(r.eventLists_.push(n),n=null),n===null&&(n={events:[],path:c}),n.events.push(l)}n&&r.eventLists_.push(n)}function q_(r,e,n){ql(r,n),Y_(r,s=>od(s,e))}function Lt(r,e,n){ql(r,n),Y_(r,s=>Dt(s,e)||Dt(e,s))}function Y_(r,e){r.recursionDepth_++;let n=!0;for(let s=0;s<r.eventLists_.length;s++){const l=r.eventLists_[s];if(l){const c=l.path;e(c)?(O1(r.eventLists_[s]),r.eventLists_[s]=null):n=!1}}n&&(r.eventLists_=[]),r.recursionDepth_--}function O1(r){for(let e=0;e<r.events.length;e++){const n=r.events[e];if(n!==null){r.events[e]=null;const s=n.getEventRunner();ms&&Ze("event: "+n.toString()),wi(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D1="repo_interrupt",L1=25;class M1{constructor(e,n,s,l){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=l,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new b1,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=kl(),this.transactionQueueTree_=new Id,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function j1(r,e,n){if(r.stats_=rd(r.repoInfo_),r.forceRestClient_||fE())r.server_=new Il(r.repoInfo_,(s,l,c,u)=>{Wm(r,s,l,c,u)},r.authTokenProvider_,r.appCheckProvider_),setTimeout(()=>Vm(r,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{$e(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}r.persistentConnection_=new gn(r.repoInfo_,e,(s,l,c,u)=>{Wm(r,s,l,c,u)},s=>{Vm(r,s)},s=>{U1(r,s)},r.authTokenProvider_,r.appCheckProvider_,n),r.server_=r.persistentConnection_}r.authTokenProvider_.addTokenChangeListener(s=>{r.server_.refreshAuthToken(s)}),r.appCheckProvider_.addTokenChangeListener(s=>{r.server_.refreshAppCheckToken(s.token)}),r.statsReporter_=yE(r.repoInfo_,()=>new _S(r.stats_,r.server_)),r.infoData_=new hS,r.infoSyncTree_=new Um({startListening:(s,l,c,u)=>{let f=[];const p=r.infoData_.getNode(s._path);return p.isEmpty()||(f=zs(r.infoSyncTree_,s._path,p),setTimeout(()=>{u("ok")},0)),f},stopListening:()=>{}}),Td(r,"connected",!1),r.serverSyncTree_=new Um({startListening:(s,l,c,u)=>(r.server_.listen(s,c,l,(f,p)=>{const g=u(f,p);Lt(r.eventQueue_,s._path,g)}),[]),stopListening:(s,l)=>{r.server_.unlisten(s,l)}})}function F1(r){const n=r.infoData_.getNode(new Ce(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Yl(r){return _1({timestamp:F1(r)})}function Wm(r,e,n,s,l){r.dataUpdateCount++;const c=new Ce(e);n=r.interceptServerDataCallback_?r.interceptServerDataCallback_(e,n):n;let u=[];if(l)if(s){const p=pl(n,g=>He(g));u=d1(r.serverSyncTree_,c,p,l)}else{const p=He(n);u=j_(r.serverSyncTree_,c,p,l)}else if(s){const p=pl(n,g=>He(g));u=a1(r.serverSyncTree_,c,p)}else{const p=He(n);u=zs(r.serverSyncTree_,c,p)}let f=c;u.length>0&&(f=pi(r,c)),Lt(r.eventQueue_,f,u)}function Vm(r,e){Td(r,"connected",e),e===!1&&B1(r)}function U1(r,e){nt(e,(n,s)=>{Td(r,n,s)})}function Td(r,e,n){const s=new Ce("/.info/"+e),l=He(n);r.infoData_.updateSnapshot(s,l);const c=zs(r.infoSyncTree_,s,l);Lt(r.eventQueue_,s,c)}function Rd(r){return r.nextWriteId_++}function z1(r,e,n){const s=h1(r.serverSyncTree_,e);return s!=null?Promise.resolve(s):r.server_.get(e).then(l=>{const c=He(l).withIndex(e._queryParams.getIndex());Ou(r.serverSyncTree_,e,n,!0);let u;if(e._queryParams.loadsAllData())u=zs(r.serverSyncTree_,e._path,c);else{const f=Rs(r.serverSyncTree_,e);u=j_(r.serverSyncTree_,e._path,c,f)}return Lt(r.eventQueue_,e._path,u),Dl(r.serverSyncTree_,e,n,null,!0),c},l=>(Vs(r,"get for query "+$e(e)+" failed: "+l),Promise.reject(new Error(l))))}function W1(r,e,n,s,l){Vs(r,"set",{path:e.toString(),value:n,priority:s});const c=Yl(r),u=He(n,s),f=yd(r.serverSyncTree_,e),p=V_(u,f,c),g=Rd(r),v=M_(r.serverSyncTree_,e,p,g,!0);ql(r.eventQueue_,v),r.server_.put(e.toString(),u.val(!0),(y,N)=>{const R=y==="ok";R||dt("set at "+e+" failed: "+y);const F=Gn(r.serverSyncTree_,g,!R);Lt(r.eventQueue_,e,F),Lu(r,l,y,N)});const x=Ad(r,e);pi(r,x),Lt(r.eventQueue_,x,[])}function V1(r,e,n,s){Vs(r,"update",{path:e.toString(),value:n});let l=!0;const c=Yl(r),u={};if(nt(n,(f,p)=>{l=!1,u[f]=W_(Me(e,f),He(p),r.serverSyncTree_,c)}),l)Ze("update() called with empty data.  Don't do anything."),Lu(r,s,"ok",void 0);else{const f=Rd(r),p=l1(r.serverSyncTree_,e,u,f);ql(r.eventQueue_,p),r.server_.merge(e.toString(),n,(g,v)=>{const x=g==="ok";x||dt("update at "+e+" failed: "+g);const y=Gn(r.serverSyncTree_,f,!x),N=y.length>0?pi(r,e):e;Lt(r.eventQueue_,N,y),Lu(r,s,g,v)}),nt(n,g=>{const v=Ad(r,Me(e,g));pi(r,v)}),Lt(r.eventQueue_,e,[])}}function B1(r){Vs(r,"onDisconnectEvents");const e=Yl(r),n=kl();Nu(r.onDisconnect_,_e(),(l,c)=>{const u=W_(l,c,r.serverSyncTree_,e);x_(n,l,u)});let s=[];Nu(n,_e(),(l,c)=>{s=s.concat(zs(r.serverSyncTree_,l,c));const u=Ad(r,l);pi(r,u)}),r.onDisconnect_=kl(),Lt(r.eventQueue_,_e(),s)}function H1(r,e,n){let s;le(e._path)===".info"?s=Ou(r.infoSyncTree_,e,n):s=Ou(r.serverSyncTree_,e,n),q_(r.eventQueue_,e._path,s)}function X_(r,e,n){let s;le(e._path)===".info"?s=Dl(r.infoSyncTree_,e,n):s=Dl(r.serverSyncTree_,e,n),q_(r.eventQueue_,e._path,s)}function $1(r){r.persistentConnection_&&r.persistentConnection_.interrupt(D1)}function Vs(r,...e){let n="";r.persistentConnection_&&(n=r.persistentConnection_.id+":"),Ze(n,...e)}function Lu(r,e,n,s){e&&wi(()=>{if(n==="ok")e(null);else{const l=(n||"error").toUpperCase();let c=l;s&&(c+=": "+s);const u=new Error(c);u.code=l,e(u)}})}function J_(r,e,n){return yd(r.serverSyncTree_,e,n)||J.EMPTY_NODE}function Pd(r,e=r.transactionQueueTree_){if(e||Xl(r,e),Ci(e)){const n=ey(r,e);M(n.length>0,"Sending zero length transaction queue"),n.every(l=>l.status===0)&&G1(r,Ws(e),n)}else H_(e)&&Kl(e,n=>{Pd(r,n)})}function G1(r,e,n){const s=n.map(g=>g.currentWriteId),l=J_(r,e,s);let c=l;const u=l.hash();for(let g=0;g<n.length;g++){const v=n[g];M(v.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),v.status=1,v.retryCount++;const x=ut(e,v.path);c=c.updateChild(x,v.currentOutputSnapshotRaw)}const f=c.val(!0),p=e;r.server_.put(p.toString(),f,g=>{Vs(r,"transaction put response",{path:p.toString(),status:g});let v=[];if(g==="ok"){const x=[];for(let y=0;y<n.length;y++)n[y].status=2,v=v.concat(Gn(r.serverSyncTree_,n[y].currentWriteId)),n[y].onComplete&&x.push(()=>n[y].onComplete(null,!0,n[y].currentOutputSnapshotResolved)),n[y].unwatcher();Xl(r,kd(r.transactionQueueTree_,e)),Pd(r,r.transactionQueueTree_),Lt(r.eventQueue_,e,v);for(let y=0;y<x.length;y++)wi(x[y])}else{if(g==="datastale")for(let x=0;x<n.length;x++)n[x].status===3?n[x].status=4:n[x].status=0;else{dt("transaction at "+p.toString()+" failed: "+g);for(let x=0;x<n.length;x++)n[x].status=4,n[x].abortReason=g}pi(r,e)}},u)}function pi(r,e){const n=Z_(r,e),s=Ws(n),l=ey(r,n);return K1(r,l,s),s}function K1(r,e,n){if(e.length===0)return;const s=[];let l=[];const u=e.filter(f=>f.status===0).map(f=>f.currentWriteId);for(let f=0;f<e.length;f++){const p=e[f],g=ut(n,p.path);let v=!1,x;if(M(g!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),p.status===4)v=!0,x=p.abortReason,l=l.concat(Gn(r.serverSyncTree_,p.currentWriteId,!0));else if(p.status===0)if(p.retryCount>=L1)v=!0,x="maxretry",l=l.concat(Gn(r.serverSyncTree_,p.currentWriteId,!0));else{const y=J_(r,p.path,u);p.currentInputSnapshot=y;const N=e[f].update(y.val());if(N!==void 0){Ql("transaction failed: Data returned ",N,p.path);let R=He(N);typeof N=="object"&&N!=null&&rn(N,".priority")||(R=R.updatePriority(y.getPriority()));const z=p.currentWriteId,L=Yl(r),U=V_(R,y,L);p.currentOutputSnapshotRaw=R,p.currentOutputSnapshotResolved=U,p.currentWriteId=Rd(r),u.splice(u.indexOf(z),1),l=l.concat(M_(r.serverSyncTree_,p.path,U,p.currentWriteId,p.applyLocally)),l=l.concat(Gn(r.serverSyncTree_,z,!0))}else v=!0,x="nodata",l=l.concat(Gn(r.serverSyncTree_,p.currentWriteId,!0))}Lt(r.eventQueue_,n,l),l=[],v&&(e[f].status=2,(function(y){setTimeout(y,Math.floor(0))})(e[f].unwatcher),e[f].onComplete&&(x==="nodata"?s.push(()=>e[f].onComplete(null,!1,e[f].currentInputSnapshot)):s.push(()=>e[f].onComplete(new Error(x),!1,null))))}Xl(r,r.transactionQueueTree_);for(let f=0;f<s.length;f++)wi(s[f]);Pd(r,r.transactionQueueTree_)}function Z_(r,e){let n,s=r.transactionQueueTree_;for(n=le(e);n!==null&&Ci(s)===void 0;)s=kd(s,n),e=ke(e),n=le(e);return s}function ey(r,e){const n=[];return ty(r,e,n),n.sort((s,l)=>s.order-l.order),n}function ty(r,e,n){const s=Ci(e);if(s)for(let l=0;l<s.length;l++)n.push(s[l]);Kl(e,l=>{ty(r,l,n)})}function Xl(r,e){const n=Ci(e);if(n){let s=0;for(let l=0;l<n.length;l++)n[l].status!==2&&(n[s]=n[l],s++);n.length=s,B_(e,n.length>0?n:void 0)}Kl(e,s=>{Xl(r,s)})}function Ad(r,e){const n=Ws(Z_(r,e)),s=kd(r.transactionQueueTree_,e);return x1(s,l=>{hu(r,l)}),hu(r,s),$_(s,l=>{hu(r,l)}),n}function hu(r,e){const n=Ci(e);if(n){const s=[];let l=[],c=-1;for(let u=0;u<n.length;u++)n[u].status===3||(n[u].status===1?(M(c===u-1,"All SENT items should be at beginning of queue."),c=u,n[u].status=3,n[u].abortReason="set"):(M(n[u].status===0,"Unexpected transaction status in abort"),n[u].unwatcher(),l=l.concat(Gn(r.serverSyncTree_,n[u].currentWriteId,!0)),n[u].onComplete&&s.push(n[u].onComplete.bind(null,new Error("set"),!1,null))));c===-1?B_(e,void 0):n.length=c+1,Lt(r.eventQueue_,Ws(e),l);for(let u=0;u<s.length;u++)wi(s[u])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hI(r){JC(yi),ci(new Cr("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),l=e.getProvider("auth-internal"),c=e.getProvider("app-check-internal");return oI(s,l,c,n)},"PUBLIC").setMultipleInstances(!0)),qn(hm,fm,r),qn(hm,fm,"esm2020")}gn.prototype.simpleListen=function(r,e){this.sendRequest("q",{p:r},e)};gn.prototype.echo=function(r,e){this.sendRequest("echo",{d:r},e)};hI();const fI={apiKey:"AIzaSyCLgGHXRhXRn6yubYySyQ9WUt1e0lDckX8",authDomain:"sekimeki-3c6d9.firebaseapp.com",databaseURL:"https://sekimeki-3c6d9-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"sekimeki-3c6d9",storageBucket:"sekimeki-3c6d9.firebasestorage.app",messagingSenderId:"269784219722",appId:"1:269784219722:web:fd1ecbae99bd3da98526b3"},ry=ag(fI),Hm=YC(ry),tt=uI(ry);let iy=null;function pI(){return new Promise((r,e)=>{Ux(Hm,n=>{n&&(iy=n.uid,r(n.uid))}),Ox(Hm).catch(e)})}function ea(){return iy??""}function $m(){const r="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";let e="";for(let n=0;n<4;n++)e+=r[Math.floor(Math.random()*r.length)];return e}async function mI(r,e){const n=ea();let s=$m(),l=await Ll(et(tt,`rooms/${s}`)),c=0;for(;l.exists()&&c<10;)s=$m(),l=await Ll(et(tt,`rooms/${s}`)),c++;return await Jl(et(tt,`rooms/${s}/config`),{mode:r,layout:e,adminId:n,state:"waiting",createdAt:Date.now()}),s}async function gI(r){return(await Ll(et(tt,`rooms/${r}/config`))).exists()}async function _I(r){const e=await Ll(et(tt,`rooms/${r}/config`));return e.exists()?e.val():null}async function yI(r,e){const n=ea();return await Jl(et(tt,`rooms/${r}/participants/${n}`),{name:e.name,gender:e.gender??null,avatar:e.avatar,answers:null,completed:!1}),n}async function vI(r){const e=ea();await Z1(et(tt,`rooms/${r}/participants/${e}`))}async function wI(r){await rr(et(tt,`rooms/${r}/config`),{state:"diagnosing"})}async function xI(r,e){const n=ea();await rr(et(tt,`rooms/${r}/participants/${n}`),{answers:e,completed:!0})}async function CI(r,e,n,s,l){const c={};for(const p of e){const g=[p.id1,p.id2].sort().join("_");c[g]={...p,visible:!0}}const u={};n.forEach((p,g)=>{u[String(g)]=p});const f={};s.forEach((p,g)=>{f[String(g)]=p}),await Jl(et(tt,`rooms/${r}/results`),{compatibility:c,seatAssignments:u,awards:f,revealed:!1}),await rr(et(tt,`rooms/${r}/config`),{state:"admin-review"});for(const[p,g]of Object.entries(l))await rr(et(tt,`rooms/${r}/participants/${p}`),g)}async function EI(r,e,n){await rr(et(tt,`rooms/${r}/results/compatibility/${e}`),{visible:n})}async function SI(r){await rr(et(tt,`rooms/${r}/results`),{revealed:!0}),await rr(et(tt,`rooms/${r}/config`),{state:"results"})}async function II(r,e,n){const s={};e.forEach((c,u)=>{s[String(u)]=c});const l={};n.forEach((c,u)=>{l[String(u)]=c}),await rr(et(tt,`rooms/${r}/results`),{seatAssignments:s,awards:l})}function kI(r,e){const n=et(tt,`rooms/${r}`);return tI(n,s=>{e(s.val())}),()=>nI(n)}function NI(){var L,U,j,Q;const[r,e]=ne.useState(""),[n,s]=ne.useState(null),[l,c]=ne.useState(null),[u,f]=ne.useState(!1);ne.useEffect(()=>{pI().then(ie=>{e(ie),f(!0)})},[]),ne.useEffect(()=>{if(!n){c(null);return}return kI(n,re=>{c(re)})},[n]);const p=l&&r?l.config.adminId===r?"admin":"participant":null,g=l!=null&&l.participants?Object.entries(l.participants).map(([ie,re])=>({id:ie,name:re.name,gender:re.gender,avatar:re.avatar,answers:re.answers??[],completed:re.completed,vector:re.vector,personalType:re.personalType,personalTypeEmoji:re.personalTypeEmoji})):[],v=g.find(ie=>ie.id===r)??null,x=(L=l==null?void 0:l.results)!=null&&L.compatibility?Object.values(l.results.compatibility):[],y=x.filter(ie=>ie.visible!==!1),N=(U=l==null?void 0:l.results)!=null&&U.seatAssignments?Object.values(l.results.seatAssignments):[],R=(j=l==null?void 0:l.results)!=null&&j.awards?Object.values(l.results.awards):[],F=((Q=l==null?void 0:l.results)==null?void 0:Q.revealed)??!1,z=g.length>0&&g.every(ie=>ie.completed);return{uid:r,roomCode:n,roomData:l,role:p,participants:g,myParticipant:v,compatibilityResults:x,visibleResults:y,seatAssignments:N,awards:R,revealed:F,allCompleted:z,isReady:u,setRoomCode:s}}const TI={S:{E:"魂のパリピ同盟",C:"以心伝心のふたり",V:"運命の冒険パートナー",L:"恋のシンクロ率MAX",H:"爆笑ソウルメイト"},A:{E:"ノリが合う飲み仲間",C:"会話キャッチボール名人",V:"趣味トーク無限ループ",L:"じわじわ来る恋の予感",H:"ツボが近い笑い仲間"},B:{E:"新しい扉を開く関係",C:"未知の言語を学ぶ感覚",V:"お互い新世界への案内人",L:"押し引きのスリルあり",H:"笑いの化学反応待ち"},C:{E:"テンションの異文化交流",C:"沈黙すら味になる関係",V:"真逆だからこそ面白い",L:"恋の迷路を楽しんで",H:"笑いの新大陸を発見せよ"}};function RI(r){return r>=85?"S":r>=70?"A":r>=55?"B":"C"}const PI=[{condition:r=>r[0]>=4&&r[2]>=4,emoji:"🌪️",name:"お祭りハリケーン"},{condition:r=>r[0]<=2&&r[4]>=4,emoji:"🎯",name:"スナイパー芸人"},{condition:r=>r[1]>=4&&r[3]>=4,emoji:"🦁",name:"恋のライオン"},{condition:r=>r[1]<=2&&r[2]<=2,emoji:"🐱",name:"癒しの守護猫"},{condition:r=>r[0]>=4&&r[4]>=4,emoji:"🎉",name:"パーティーモンスター"},{condition:r=>r[0]>=4&&r[3]>=4,emoji:"💘",name:"情熱のストライカー"},{condition:r=>r[2]>=4&&r[4]>=4,emoji:"🎪",name:"アドベンチャーコメディアン"},{condition:r=>r[0]<=2&&r[2]<=2,emoji:"🏠",name:"おうちの守り神"},{condition:r=>r[1]>=4&&r[4]>=4,emoji:"🎤",name:"トークの魔術師"},{condition:r=>r[3]<=2&&r[1]<=2,emoji:"🌙",name:"ミステリアスな月"},{condition:r=>r[0]>=4&&r[1]>=4,emoji:"☀️",name:"太陽系リーダー"},{condition:r=>r[3]>=4&&r[2]>=4,emoji:"🚀",name:"恋のロケットランチャー"},{condition:r=>r[0]<=2&&r[3]<=2,emoji:"🍵",name:"まったり茶道マスター"},{condition:r=>r[2]<=2&&r[4]<=2,emoji:"📚",name:"哲学者の休日"},{condition:r=>r[1]<=2&&r[4]>=4,emoji:"🎭",name:"ギャップの天才"},{condition:r=>{const e=r.reduce((n,s)=>n+s,0)/5;return r.every(n=>Math.abs(n-e)<1)},emoji:"🌈",name:"万能カメレオン"}];function AI(r){for(const e of PI)if(e.condition(r))return{emoji:e.emoji,name:e.name};return{emoji:"🌈",name:"万能カメレオン"}}const fu={E:{common:["2人とも行きたい「最高の金曜夜プラン」を3秒で答えて！","理想の飲み会メンバー、有名人3人だけ呼べるなら？","一緒に行くならフェス？それとも秘境温泉？"],diff:["お互いの「理想の金曜夜」をプレゼンしてみて！","インドア派 vs アウトドア派、1分ディベート開始！","相手の趣味を1つ体験するなら何にする？"]},C:{common:["最近あった「聞いてほしい話」を30秒で！","2人で一番盛り上がれる話題は何だと思う？","お互いの第一印象、正直に言い合おう！"],diff:["じゃあ今から1分間、いつもと逆の会話スタイルで話してみよう！","「相手に聞いてみたかったこと」を3つ！","2人の会話スタイルが合体したら最強説、検証！"]},V:{common:["次の3連休、予定なかったらどこ行く？3秒で！","2人で旅行に行くならどの国？","「これだけはやってみたいこと」を1つずつ！"],diff:["相手の価値観で1日過ごすなら何する？","お互いの「譲れないこだわり」を発表！","もし2人で24時間お出かけするなら、プランどう立てる？"]},L:{common:["理想のデートプラン、相手に聞かずに考えて同時に発表！","「こんなサプライズされたらキュンとする」を告白！","恋愛映画でどのシーンに一番グッとくる？"],diff:["もし2人でドラマに出るなら、どんなジャンル？","お互いの恋愛の距離感を料理で例えると？","「この人いいな」と思う瞬間を3秒で！"]},H:{common:["今まで一番笑った出来事は？","一緒に見るなら何のお笑い番組？","相手をお笑い芸人に例えると誰？"],diff:["お互いの笑いのツボを探る質問タイム！","1分間で相手を笑わせるチャレンジ！","「この人面白いな」と思った瞬間を再現！"]}},Fu=[{id:1,axis:"E",text:"金曜の夜、理想の過ごし方は？",leftLabel:"少人数でゆったりバー",rightLabel:"大人数でワイワイ飲み会"},{id:2,axis:"E",text:"旅行先で盛り上がるのは？",leftLabel:"隠れ家カフェ巡り",rightLabel:"有名スポットで写真撮りまくり"},{id:3,axis:"C",text:"初対面の人との会話スタイルは？",leftLabel:"相手の話をじっくり聞く",rightLabel:"自分から話題をどんどん振る"},{id:4,axis:"C",text:"友達の悩み相談、あなたの対応は？",leftLabel:"まず気持ちに寄り添う",rightLabel:"一緒に解決策を考える"},{id:5,axis:"V",text:"理想の休日は？",leftLabel:"おうちでまったり",rightLabel:"外に出てアクティブに"},{id:6,axis:"V",text:"旅行のスタイルは？",leftLabel:"計画をしっかり立てる",rightLabel:"ノープランで行き当たりばったり"},{id:7,axis:"L",text:"気になる人へのアプローチは？",leftLabel:"じっくり友達から",rightLabel:"すぐに距離を詰める"},{id:8,axis:"L",text:"デートに誘うなら？",leftLabel:"自然な流れを待つ",rightLabel:"ストレートに誘う"},{id:9,axis:"H",text:"笑いのツボに近いのは？",leftLabel:"じわじわ来る知的なウィット",rightLabel:"勢いとテンションで爆笑"},{id:10,axis:"H",text:"飲み会での立ち位置は？",leftLabel:"絶妙なタイミングで一言",rightLabel:"場を仕切るMC役"}],Uu={E:.25,C:.2,V:.2,L:.2,H:.15},bI=["E","V","H"],OI=["C","L"],DI=1.5,LI=1.2;function MI(r){return["E","C","V","L","H"].map(n=>{const c=Fu.filter(u=>u.axis===n).map(u=>u.id-1).map(u=>r[u]??3);return c.reduce((u,f)=>u+f,0)/c.length})}function jI(r,e){return 1-Math.abs(r-e)/4}function FI(r,e){const n=Math.abs(r-e);return Math.exp(-((n-DI)**2)/(2*LI**2))}function UI(r,e){const n=["E","C","V","L","H"],s={};return n.forEach((l,c)=>{bI.includes(l)?s[l]=jI(r[c],e[c]):OI.includes(l)&&(s[l]=FI(r[c],e[c]))}),s}function zI(r){let e=0;for(const n of Object.keys(Uu))e+=Uu[n]*r[n];return e}function WI(r){return Math.round(40+r*55)}function VI(r){const e=["E","C","V","L","H"];let n=-1,s="E";for(const l of e){const c=Uu[l]*r[l];c>n&&(n=c,s=l)}return s}function BI(r,e){var s;const n=RI(r);return((s=TI[n])==null?void 0:s[e])??"未知の化学反応"}function HI(r){const e=[];for(let n=0;n<r.length;n++)for(let s=n+1;s<r.length;s++){const l=r[n],c=r[s];if(!l.vector||!c.vector)continue;const u=UI(l.vector,c.vector),f=zI(u),p=WI(f),g=VI(u),v=BI(p,g);e.push({id1:l.id,id2:c.id,axisScores:u,rawScore:f,displayScore:p,typeName:v,topAxis:g})}return e}function Bs(r,e,n){return r.find(s=>s.id1===e&&s.id2===n||s.id1===n&&s.id2===e)}function sy(r,e){const n=Array.from({length:e},()=>Array(e).fill(0));switch(r){case"facing-long":case"facing-short":{const s=Math.ceil(e/2);for(let l=0;l<s;l++){for(let c=s;c<e;c++){const u=l,f=c-s,p=Math.abs(u-f);p===0?n[l][c]=n[c][l]=1:p===1&&(n[l][c]=n[c][l]=.5)}l+1<s&&(n[l][l+1]=n[l+1][l]=.3)}for(let l=s;l<e-1;l++)n[l][l+1]=n[l+1][l]=.3;break}case"round":{for(let s=0;s<e;s++)for(let l=s+1;l<e;l++){const c=Math.min(Math.abs(s-l),e-Math.abs(s-l));c===1?n[s][l]=n[l][s]=1:c===2?n[s][l]=n[l][s]=.4:c===Math.floor(e/2)?n[s][l]=n[l][s]=.3:c===3&&(n[s][l]=n[l][s]=.1)}break}case"counter":{for(let s=0;s<e;s++)for(let l=s+1;l<e;l++){const c=Math.abs(s-l);c===1?n[s][l]=n[l][s]=1:c===2&&(n[s][l]=n[l][s]=.2)}break}case"alternate":{for(let s=0;s<e;s++)for(let l=s+1;l<e;l++){const c=s<Math.ceil(e/2)?0:1,u=l<Math.ceil(e/2)?0:1,f=c===0?s:s-Math.ceil(e/2),p=u===0?l:l-Math.ceil(e/2);if(c!==u){const g=Math.abs(f-p);g===0?n[s][l]=n[l][s]=1:g===1&&(n[s][l]=n[l][s]=.5)}else Math.abs(f-p)===1&&(n[s][l]=n[l][s]=.3)}break}case"l-shape":{for(let s=0;s<e;s++)for(let l=s+1;l<e;l++){const c=Math.abs(s-l);c===1?n[s][l]=n[l][s]=1:c===2&&(n[s][l]=n[l][s]=.3)}break}}return n}function $I(r,e,n,s){if(s==="free")return n;const l=r.gender!==e.gender;return n*(l?1:.2)}function As(r,e,n,s,l){let c=0;for(let u=0;u<e.length;u++)for(let f=u+1;f<e.length;f++){const p=Bs(n,e[u].id,e[f].id);if(!p)continue;const g=s[r[u]][r[f]],v=$I(e[u],e[f],g,l);c+=p.rawScore*v}return c}function GI(r,e,n,s,l){let c=1/0;for(let u=0;u<e.length;u++)for(let f=u+1;f<e.length;f++){if(l==="goukon"&&e[u].gender===e[f].gender||s[r[u]][r[f]]<.5)continue;const p=Bs(n,e[u].id,e[f].id);p&&p.rawScore<c&&(c=p.rawScore)}return c===1/0?0:c}function oy(r){if(r.length<=1)return[r];const e=[];for(let n=0;n<r.length;n++){const s=[...r.slice(0,n),...r.slice(n+1)];for(const l of oy(s))e.push([r[n],...l])}return e}function KI(r,e,n,s){const l=r.length,c=Array.from({length:l},(y,N)=>N),u=oy(c);let f=-1/0,p=-1/0,g=c;const v=.95;let x=-1/0;for(const y of u){const N=As(y,r,e,n,s);N>x&&(x=N)}for(const y of u){const N=As(y,r,e,n,s);if(N>=x*v){const R=GI(y,r,e,n,s);(R>p||R===p&&N>f)&&(p=R,f=N,g=[...y])}}return g}function QI(r,e,n,s){const l=r.length;let c=Array.from({length:l},(N,R)=>R);for(let N=l-1;N>0;N--){const R=Math.floor(Math.random()*(N+1));[c[N],c[R]]=[c[R],c[N]]}let u=As(c,r,e,n,s),f=[...c],p=u;const g=100,v=.995,x=.01,y=1e4;for(let N=0;N<3;N++){let R=g,F=0;for(;R>x&&F<y;){const z=Math.floor(Math.random()*l);let L=Math.floor(Math.random()*(l-1));L>=z&&L++;const U=[...c];[U[z],U[L]]=[U[L],U[z]];const j=As(U,r,e,n,s),Q=j-u;(Q>0||Math.random()<Math.exp(Q/R))&&(c=U,u=j,u>p&&(f=[...c],p=u)),R*=v,F++}}return f}function dl(r,e,n,s){const l=r.length;if(l<=1)return r.map((f,p)=>({participantId:f.id,seatIndex:p}));const c=sy(n,l),u=l<=10?KI(r,e,c,s):QI(r,e,c,s);return r.map((f,p)=>({participantId:f.id,seatIndex:u[p]}))}function qI(r,e,n,s,l,c){if(l<=1)return dl(r,e,n,s);const u=r.length,f=sy(n,u);if(l===2){let g=c,v=-1/0;for(let x=0;x<u;x++)for(let y=x+1;y<u;y++){if(s==="goukon"&&r[x].gender!==r[y].gender)continue;const N=[...c],R=N[x].seatIndex;N[x]={...N[x],seatIndex:N[y].seatIndex},N[y]={...N[y],seatIndex:R};const F=N.map(L=>L.seatIndex),z=As(F,r,e,f,s);z>v&&(v=z,g=N)}return g}if(l===3)return dl(r,e,n,s);const p=dl(r,e,n,s);for(let g=u-1;g>0;g--)if(Math.random()<.5){const v=Math.floor(Math.random()*(g+1)),x=p[g].seatIndex;p[g]={...p[g],seatIndex:p[v].seatIndex},p[v]={...p[v],seatIndex:x}}return p}function Gm(r,e,n){const s=[],l=[];for(let L=0;L<r.length;L++)for(let U=L+1;U<r.length;U++){const j=n.find(re=>re.participantId===r[L].id),Q=n.find(re=>re.participantId===r[U].id);if(!j||!Q)continue;const ie=Math.abs(j.seatIndex-Q.seatIndex);if(ie<=1||ie===r.length-1){const re=Bs(e,r[L].id,r[U].id);re&&l.push([r[L],r[U],re])}}const c=e.map(L=>({p1:r.find(U=>U.id===L.id1),p2:r.find(U=>U.id===L.id2),result:L}));if(l.length>0){const L=l.reduce((U,j)=>U[2].displayScore>=j[2].displayScore?U:j);s.push({emoji:"👑",title:"ベストマッチ賞",description:`最高の席順相性！${L[2].displayScore}点`,targetIds:[L[0].id,L[1].id]})}const u=c.find(L=>L.result.displayScore>=90);u&&s.push({emoji:"🔥",title:"運命の出会い賞",description:`相性${u.result.displayScore}点の奇跡！`,targetIds:[u.p1.id,u.p2.id]});let f=-1,p=null;for(const L of c){const U=Object.values(L.result.axisScores),j=U.reduce((ie,re)=>ie+re,0)/U.length,Q=U.reduce((ie,re)=>ie+(re-j)**2,0)/U.length;Q>f&&(f=Q,p=L)}p&&s.push({emoji:"🌀",title:"カオスコンビ賞",description:"予測不能な化学反応！",targetIds:[p.p1.id,p.p2.id]});let g=-1,v=null;for(const L of c){const U=L.result.axisScores.C+L.result.axisScores.L;U>g&&(g=U,v=L)}v&&s.push({emoji:"🎭",title:"ミステリアス賞",description:"真逆だからこそ惹かれる！",targetIds:[v.p1.id,v.p2.id]});let x=-1,y=null;for(const L of r){if(!L.vector)continue;const U=L.vector[0]+L.vector[1];U>x&&(x=U,y=L)}y&&s.push({emoji:"🎤",title:"パーティーMC賞",description:"場を盛り上げるMVP！",targetIds:[y.id]});let N=1/0,R=null;for(const L of r)L.vector&&L.vector[0]<N&&(N=L.vector[0],R=L);R&&R.id!==(y==null?void 0:y.id)&&s.push({emoji:"🐱",title:"癒しオーラ賞",description:"ほっとする存在感！",targetIds:[R.id]});let F=-1,z=null;for(const L of r){const U=e.filter(Q=>Q.id1===L.id||Q.id2===L.id);if(U.length===0)continue;const j=U.reduce((Q,ie)=>Q+ie.displayScore,0)/U.length;j>F&&(F=j,z=L)}return z&&s.push({emoji:"🔄",title:"万能プレイヤー賞",description:"誰とでも仲良くなれる！",targetIds:[z.id]}),s}const YI=({onStart:r,onJoin:e})=>_.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-center px-6 text-center",children:[_.jsx("div",{className:"fixed inset-0 overflow-hidden pointer-events-none",children:[...Array(20)].map((n,s)=>_.jsx("div",{className:"absolute rounded-full opacity-20",style:{width:`${Math.random()*6+2}px`,height:`${Math.random()*6+2}px`,left:`${Math.random()*100}%`,top:`${Math.random()*100}%`,backgroundColor:["#ff6b6b","#4ecdc4","#ffd93d"][s%3],animation:`float ${3+Math.random()*4}s ease-in-out infinite`,animationDelay:`${Math.random()*3}s`}},s))}),_.jsxs("div",{className:"animate-fade-in relative z-10",children:[_.jsx("div",{className:"text-6xl mb-4",children:"🍻"}),_.jsx("h1",{className:"text-5xl font-black tracking-tight mb-2",children:_.jsx("span",{className:"bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent",children:"SEKIMEKI"})}),_.jsx("p",{className:"text-lg text-gray-300 mb-12 font-medium",children:"「運命の席順、決めます」"}),_.jsxs("div",{className:"space-y-4 w-full max-w-xs mx-auto",children:[_.jsx("button",{onClick:r,className:"w-full py-4 px-8 bg-gradient-to-r from-primary to-pink-500 text-white font-bold text-lg rounded-2xl shadow-lg hover:shadow-primary/30 hover:scale-105 transition-all duration-200 active:scale-95",children:"ルームをつくる"}),_.jsx("button",{onClick:e,className:"w-full py-4 px-8 bg-gray-800/80 border-2 border-gray-600 text-white font-bold text-lg rounded-2xl hover:border-secondary hover:bg-gray-700/80 transition-all duration-200 active:scale-95",children:"コードで参加する"})]}),_.jsx("p",{className:"mt-8 text-sm text-gray-500",children:"※アプリ不要・登録不要"}),_.jsx("p",{className:"mt-2 text-xs text-gray-600",children:"各自のスマホで診断 → 最適な席順を提案！"})]}),_.jsx("style",{children:`
        @keyframes float {
          0%, 100% { transform: translateY(0) rotate(0deg); }
          50% { transform: translateY(-20px) rotate(180deg); }
        }
      `})]}),XI=[{id:"facing-long",name:"対面ロング",icon:"═══",desc:"向かい合う長テーブル"},{id:"facing-short",name:"対面ショート",icon:"═══",desc:"向かい合う短テーブル"},{id:"round",name:"円卓",icon:"◯",desc:"丸テーブル"},{id:"counter",name:"カウンター",icon:"───",desc:"横並びカウンター席"},{id:"alternate",name:"交互型",icon:"⊞",desc:"男女交互に配置"},{id:"l-shape",name:"L字・コの字",icon:"⌐",desc:"L字型テーブル"}],JI=({onComplete:r,onBack:e})=>{const[n,s]=ne.useState("goukon"),[l,c]=ne.useState("facing-long");return _.jsxs("div",{className:"min-h-screen px-6 py-8",children:[_.jsx("button",{onClick:e,className:"text-gray-400 hover:text-white mb-6 flex items-center gap-2 transition-colors",children:"← 戻る"}),_.jsx("h2",{className:"text-2xl font-bold mb-8 animate-fade-in",children:"ルーム設定"}),_.jsxs("div",{className:"mb-8 animate-slide-up",children:[_.jsx("h3",{className:"text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3",children:"モード"}),_.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[_.jsxs("button",{onClick:()=>s("goukon"),className:`p-4 rounded-xl border-2 transition-all ${n==="goukon"?"border-primary bg-primary/10 shadow-lg shadow-primary/20":"border-gray-700 hover:border-gray-500"}`,children:[_.jsx("div",{className:"text-2xl mb-1",children:"💕"}),_.jsx("div",{className:"font-bold text-sm",children:"合コンモード"}),_.jsx("div",{className:"text-xs text-gray-400 mt-1",children:"男女別で席配置"})]}),_.jsxs("button",{onClick:()=>s("free"),className:`p-4 rounded-xl border-2 transition-all ${n==="free"?"border-secondary bg-secondary/10 shadow-lg shadow-secondary/20":"border-gray-700 hover:border-gray-500"}`,children:[_.jsx("div",{className:"text-2xl mb-1",children:"🎉"}),_.jsx("div",{className:"font-bold text-sm",children:"フリーモード"}),_.jsx("div",{className:"text-xs text-gray-400 mt-1",children:"性別不問で席配置"})]})]})]}),_.jsxs("div",{className:"mb-8 animate-slide-up",style:{animationDelay:"0.1s"},children:[_.jsx("h3",{className:"text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3",children:"席の配置"}),_.jsx("div",{className:"grid grid-cols-2 gap-3",children:XI.map(u=>_.jsxs("button",{onClick:()=>c(u.id),className:`p-4 rounded-xl border-2 transition-all text-left ${l===u.id?"border-accent bg-accent/10 shadow-lg shadow-accent/20":"border-gray-700 hover:border-gray-500"}`,children:[_.jsx("div",{className:"text-lg font-mono mb-1 text-gray-300",children:u.icon}),_.jsx("div",{className:"font-bold text-sm",children:u.name}),_.jsx("div",{className:"text-xs text-gray-400 mt-1",children:u.desc})]},u.id))})]}),_.jsx("button",{onClick:()=>r(n,l),className:"w-full py-4 bg-gradient-to-r from-primary to-pink-500 text-white font-bold text-lg rounded-2xl shadow-lg hover:scale-105 transition-all duration-200 active:scale-95",children:"ルームを作成する"})]})},ZI=({onJoin:r,onBack:e})=>{const[n,s]=ne.useState(""),[l,c]=ne.useState(""),[u,f]=ne.useState(!1),p=async()=>{const g=n.trim().toUpperCase();if(g.length!==4){c("4文字のコードを入力してください");return}f(!0),c("");const v=await gI(g);if(f(!1),!v){c("ルームが見つかりません");return}r(g)};return _.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-center px-6",children:[_.jsx("button",{onClick:e,className:"absolute top-6 left-6 text-gray-400 hover:text-white transition-colors",children:"← 戻る"}),_.jsxs("div",{className:"w-full max-w-xs animate-fade-in",children:[_.jsx("div",{className:"text-4xl text-center mb-4",children:"🔑"}),_.jsx("h2",{className:"text-2xl font-bold text-center mb-8",children:"ルームに参加"}),_.jsxs("div",{className:"mb-6",children:[_.jsx("label",{className:"block text-sm text-gray-400 mb-2",children:"ルームコード"}),_.jsx("input",{type:"text",value:n,onChange:g=>{s(g.target.value.toUpperCase().slice(0,4)),c("")},placeholder:"例：A3K7",maxLength:4,className:"w-full bg-gray-900/60 border border-gray-600 rounded-xl px-4 py-4 text-white text-center text-3xl font-mono tracking-[0.5em] placeholder-gray-600 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/50 transition-colors uppercase",onKeyDown:g=>g.key==="Enter"&&p(),autoFocus:!0}),l&&_.jsx("p",{className:"text-red-400 text-sm mt-2 text-center",children:l})]}),_.jsx("button",{onClick:p,disabled:n.length!==4||u,className:"w-full py-4 bg-gradient-to-r from-secondary to-teal-400 text-white font-bold text-lg rounded-2xl shadow-lg hover:scale-105 transition-all duration-200 active:scale-95 disabled:opacity-30 disabled:cursor-not-allowed",children:u?"確認中...":"参加する"})]})]})},ht=[{id:"dog",emoji:"🐶",label:"イヌ"},{id:"cat",emoji:"🐱",label:"ネコ"},{id:"bear",emoji:"🐻",label:"クマ"},{id:"fox",emoji:"🦊",label:"キツネ"},{id:"lion",emoji:"🦁",label:"ライオン"},{id:"rabbit",emoji:"🐰",label:"ウサギ"},{id:"panda",emoji:"🐼",label:"パンダ"},{id:"penguin",emoji:"🐧",label:"ペンギン"},{id:"koala",emoji:"🐨",label:"コアラ"},{id:"unicorn",emoji:"🦄",label:"ユニコーン"},{id:"dolphin",emoji:"🐬",label:"イルカ"},{id:"owl",emoji:"🦉",label:"フクロウ"},{id:"tiger",emoji:"🐯",label:"トラ"},{id:"monkey",emoji:"🐵",label:"サル"},{id:"wolf",emoji:"🐺",label:"オオカミ"},{id:"hamster",emoji:"🐹",label:"ハムスター"}],ek=({mode:r,usedAvatars:e,onSubmit:n,onBack:s})=>{var y;const[l,c]=ne.useState(""),[u,f]=ne.useState("male"),p=ht.filter(N=>!e.includes(N.id)),[g,v]=ne.useState(((y=p[0])==null?void 0:y.id)??ht[0].id),x=()=>{l.trim()&&n({name:l.trim(),gender:r==="goukon"?u:void 0,avatar:g})};return _.jsxs("div",{className:"min-h-screen px-6 py-8",children:[_.jsx("button",{onClick:s,className:"text-gray-400 hover:text-white mb-6 flex items-center gap-2 transition-colors",children:"← 戻る"}),_.jsxs("div",{className:"animate-fade-in",children:[_.jsx("div",{className:"text-4xl text-center mb-2",children:"✨"}),_.jsx("h2",{className:"text-2xl font-bold text-center mb-8",children:"プロフィール登録"}),_.jsxs("div",{className:"bg-gray-800/40 rounded-2xl p-5 border border-gray-700/50",children:[_.jsxs("div",{className:"mb-4",children:[_.jsx("label",{className:"block text-sm text-gray-400 mb-1",children:"ニックネーム"}),_.jsx("input",{type:"text",value:l,onChange:N=>c(N.target.value),placeholder:"最大8文字",maxLength:8,className:"w-full bg-gray-900/60 border border-gray-600 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/50 transition-colors",autoFocus:!0})]}),r==="goukon"&&_.jsxs("div",{className:"mb-4",children:[_.jsx("label",{className:"block text-sm text-gray-400 mb-1",children:"性別"}),_.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[_.jsx("button",{onClick:()=>f("male"),className:`py-2 rounded-xl border-2 font-medium transition-all ${u==="male"?"border-blue-400 bg-blue-500/10 text-blue-300":"border-gray-700 text-gray-400"}`,children:"♂ 男性"}),_.jsx("button",{onClick:()=>f("female"),className:`py-2 rounded-xl border-2 font-medium transition-all ${u==="female"?"border-pink-400 bg-pink-500/10 text-pink-300":"border-gray-700 text-gray-400"}`,children:"♀ 女性"})]})]}),_.jsxs("div",{className:"mb-4",children:[_.jsx("label",{className:"block text-sm text-gray-400 mb-2",children:"アイコン"}),_.jsx("div",{className:"grid grid-cols-8 gap-2",children:ht.map(N=>{const R=e.includes(N.id);return _.jsx("button",{onClick:()=>!R&&v(N.id),disabled:R,className:`text-2xl p-2 rounded-xl transition-all ${R?"opacity-20 cursor-not-allowed":g===N.id?"bg-accent/20 ring-2 ring-accent scale-110":"hover:bg-gray-700/50"}`,children:N.emoji},N.id)})})]}),_.jsx("button",{onClick:x,disabled:!l.trim(),className:"w-full py-4 bg-gradient-to-r from-primary to-pink-500 text-white font-bold text-lg rounded-2xl shadow-lg hover:scale-105 transition-all duration-200 active:scale-95 disabled:opacity-30 disabled:cursor-not-allowed",children:"参加する！"})]})]})]})},tk=({roomCode:r,participants:e,role:n,onStartDiagnosis:s,onBack:l})=>{const c=e.length>=3;return _.jsxs("div",{className:"min-h-screen px-6 py-8",children:[_.jsx("button",{onClick:l,className:"text-gray-400 hover:text-white mb-6 flex items-center gap-2 transition-colors",children:"← 退出"}),_.jsxs("div",{className:"text-center mb-8 animate-fade-in",children:[_.jsx("h2",{className:"text-2xl font-bold mb-4",children:"ルーム"}),_.jsxs("div",{className:"inline-block bg-gray-800/80 rounded-2xl px-8 py-4 border border-gray-600/50 mb-4",children:[_.jsx("p",{className:"text-xs text-gray-400 mb-1",children:"ルームコード"}),_.jsx("p",{className:"text-4xl font-mono font-black tracking-[0.3em] text-accent",children:r})]}),_.jsx("p",{className:"text-sm text-gray-400",children:"このコードを共有して参加してもらおう"})]}),_.jsxs("div",{className:"mb-8",children:[_.jsxs("h3",{className:"text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3",children:["参加者 (",e.length,"名)"]}),_.jsx("div",{className:"space-y-2",children:e.map((u,f)=>{const p=ht.find(g=>g.id===u.avatar);return _.jsxs("div",{className:"flex items-center gap-3 bg-gray-800/60 rounded-xl px-4 py-3 animate-slide-up",style:{animationDelay:`${f*.1}s`},children:[_.jsx("span",{className:"text-2xl",children:p==null?void 0:p.emoji}),_.jsx("span",{className:"font-medium flex-1",children:u.name}),u.gender&&_.jsx("span",{className:`text-xs px-2 py-0.5 rounded-full ${u.gender==="male"?"bg-blue-500/20 text-blue-300":"bg-pink-500/20 text-pink-300"}`,children:u.gender==="male"?"♂":"♀"})]},u.id)})}),e.length===0&&_.jsx("div",{className:"text-center text-gray-500 py-8 animate-pulse-slow",children:"参加者を待っています..."})]}),n==="admin"?_.jsx("div",{children:_.jsx("button",{onClick:s,disabled:!c,className:`w-full py-4 font-bold text-lg rounded-2xl shadow-lg transition-all duration-200 ${c?"bg-gradient-to-r from-primary to-pink-500 text-white hover:scale-105 active:scale-95":"bg-gray-700 text-gray-500 cursor-not-allowed"}`,children:c?"🚀 診断スタート！":`あと${3-e.length}人で開始できます`})}):_.jsx("div",{className:"text-center py-4",children:_.jsxs("div",{className:"inline-flex items-center gap-2 bg-gray-800/60 rounded-full px-6 py-3",children:[_.jsx("div",{className:"w-2 h-2 bg-secondary rounded-full animate-pulse"}),_.jsx("span",{className:"text-gray-300 text-sm",children:"幹事がスタートするまでお待ちください"})]})})]})};function nk(r){const e=Fu.map((s,l)=>l);let n=0;for(let s=0;s<r.length;s++)n=(n<<5)-n+r.charCodeAt(s)|0;for(let s=e.length-1;s>0;s--){n=(n<<5)-n+s|0;const l=Math.abs(n)%(s+1);[e[s],e[l]]=[e[l],e[s]]}return e.map(s=>({...Fu[s],originalIndex:s}))}const pu=9,rk=({participant:r,onComplete:e})=>{const[n,s]=ne.useState(!1),[l,c]=ne.useState(0),[u,f]=ne.useState(Array(10).fill(0)),[p,g]=ne.useState(3),[v,x]=ne.useState(pu),[y,N]=ne.useState(!1),R=Qm.useMemo(()=>nk(r.id),[r.id]),F=ht.find(U=>U.id===r.avatar),z=ne.useCallback(U=>{if(y)return;N(!0);const j=[...u];j[R[l].originalIndex]=U,f(j),l<9?setTimeout(()=>{c(Q=>Q+1),g(3),x(pu),N(!1)},300):setTimeout(()=>{e(j)},300)},[u,l,R,y,e]);if(ne.useEffect(()=>{if(!n)return;const U=setInterval(()=>{x(j=>j<=1?(z(3),pu):j-1)},1e3);return()=>clearInterval(U)},[n,l,z]),!n)return _.jsx("div",{className:"min-h-screen flex flex-col items-center justify-center px-6 text-center",children:_.jsxs("div",{className:"animate-pop",children:[_.jsx("div",{className:"text-6xl mb-4",children:F==null?void 0:F.emoji}),_.jsxs("h2",{className:"text-3xl font-bold mb-2",children:[r.name,"さん"]}),_.jsx("p",{className:"text-sm text-gray-500 mb-8",children:"10問の質問に答えてね（1問9秒）"}),_.jsx("button",{onClick:()=>s(!0),className:"py-4 px-12 bg-gradient-to-r from-secondary to-teal-400 text-white font-bold text-lg rounded-2xl shadow-lg hover:scale-105 transition-all active:scale-95",children:"スタート！"})]})});const L=R[l];return _.jsxs("div",{className:"min-h-screen flex flex-col px-6 py-8",children:[_.jsxs("div",{className:"flex items-center justify-between mb-4",children:[_.jsxs("div",{className:"flex items-center gap-2",children:[_.jsx("span",{className:"text-xl",children:F==null?void 0:F.emoji}),_.jsx("span",{className:"text-sm font-medium text-gray-400",children:r.name})]}),_.jsxs("span",{className:"text-sm text-gray-500",children:[l+1," / 10"]})]}),_.jsx("div",{className:"w-full h-1.5 bg-gray-800 rounded-full mb-2 overflow-hidden",children:_.jsx("div",{className:"h-full bg-gradient-to-r from-primary to-secondary rounded-full transition-all duration-300",style:{width:`${(l+1)/10*100}%`}})}),_.jsx("div",{className:"flex justify-end mb-6",children:_.jsxs("div",{className:`text-sm font-mono font-bold px-3 py-1 rounded-full transition-colors ${v<=3?"bg-red-500/20 text-red-400 animate-pulse":"bg-gray-800 text-gray-400"}`,children:[v,"s"]})}),_.jsx("div",{className:"flex-1 flex flex-col justify-center",children:_.jsxs("div",{className:`animate-slide-in-right ${y?"opacity-50":""}`,children:[_.jsx("h3",{className:"text-2xl font-bold text-center mb-12 leading-relaxed",children:L.text}),_.jsxs("div",{className:"flex justify-between mb-4 px-2",children:[_.jsx("span",{className:"text-xs text-gray-400 max-w-[120px] text-left",children:L.leftLabel}),_.jsx("span",{className:"text-xs text-gray-400 max-w-[120px] text-right",children:L.rightLabel})]}),_.jsx("div",{className:"flex gap-3 justify-center mb-8",children:[1,2,3,4,5].map(U=>_.jsx("button",{onClick:()=>g(U),className:`w-14 h-14 rounded-2xl font-bold text-lg transition-all duration-200 ${p===U?"bg-gradient-to-br from-primary to-pink-500 text-white scale-110 shadow-lg shadow-primary/30":"bg-gray-800 text-gray-400 hover:bg-gray-700"}`,children:U},U))}),_.jsx("button",{onClick:()=>z(p),disabled:y,className:"w-full py-4 bg-gradient-to-r from-primary to-pink-500 text-white font-bold text-lg rounded-2xl shadow-lg hover:scale-105 transition-all duration-200 active:scale-95 disabled:opacity-50",children:l<9?"次へ":"回答完了！"})]},l)})]})},ik=({participants:r,results:e,seatAssignments:n,awards:s,layout:l,onTogglePair:c,onReveal:u,onReshuffle:f,revealed:p})=>{const g=[...e].sort((v,x)=>x.displayScore-v.displayScore);return _.jsxs("div",{className:"min-h-screen px-6 py-8 pb-32",children:[_.jsxs("div",{className:"text-center mb-8 animate-fade-in",children:[_.jsx("div",{className:"text-4xl mb-2",children:"👑"}),_.jsx("h2",{className:"text-2xl font-bold mb-2",children:_.jsx("span",{className:"bg-gradient-to-r from-accent to-primary bg-clip-text text-transparent",children:"管理者画面"})}),_.jsx("p",{className:"text-sm text-gray-400",children:p?"結果は公開済みです":"表示するペアを選択して結果を公開してください"})]}),_.jsxs("div",{className:"mb-8",children:[_.jsx("h3",{className:"text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3",children:"ペア表示設定"}),_.jsx("div",{className:"space-y-2",children:g.map(v=>{const x=r.find(L=>L.id===v.id1),y=r.find(L=>L.id===v.id2);if(!x||!y)return null;const N=ht.find(L=>L.id===x.avatar),R=ht.find(L=>L.id===y.avatar),F=[v.id1,v.id2].sort().join("_"),z=v.visible!==!1;return _.jsxs("div",{className:`rounded-xl p-4 border transition-all ${z?"bg-gray-800/60 border-gray-600/50":"bg-gray-900/40 border-gray-800/50 opacity-60"}`,children:[_.jsxs("div",{className:"flex items-center gap-3",children:[_.jsx("button",{onClick:()=>c(F,!z),className:`relative w-12 h-6 rounded-full transition-colors flex-shrink-0 ${z?"bg-secondary":"bg-gray-700"}`,children:_.jsx("div",{className:`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${z?"translate-x-6":"translate-x-0.5"}`})}),_.jsxs("div",{className:"flex items-center gap-2 flex-1 min-w-0",children:[_.jsx("span",{className:"text-lg",children:N==null?void 0:N.emoji}),_.jsx("span",{className:"text-sm truncate",children:x.name}),_.jsx("span",{className:"text-gray-600 text-xs",children:"×"}),_.jsx("span",{className:"text-sm truncate",children:y.name}),_.jsx("span",{className:"text-lg",children:R==null?void 0:R.emoji})]}),_.jsxs("div",{className:"flex-shrink-0 text-right",children:[_.jsx("span",{className:`text-lg font-bold ${v.displayScore>=85?"text-primary":v.displayScore>=70?"text-accent":v.displayScore>=55?"text-secondary":"text-gray-400"}`,children:v.displayScore}),_.jsx("span",{className:"text-xs text-gray-500",children:"点"})]})]}),_.jsx("div",{className:"mt-1 ml-15 text-xs text-gray-500 pl-[60px]",children:v.typeName})]},F)})})]}),_.jsxs("div",{className:"mb-8",children:[_.jsx("h3",{className:"text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3",children:"称号プレビュー"}),_.jsx("div",{className:"space-y-2",children:s.map((v,x)=>{const y=v.targetIds.map(N=>r.find(R=>R.id===N)).filter(Boolean);return _.jsxs("div",{className:"flex items-center gap-3 bg-gray-800/40 rounded-xl px-4 py-2 border border-gray-700/30",children:[_.jsx("span",{className:"text-xl",children:v.emoji}),_.jsxs("div",{className:"flex-1",children:[_.jsx("span",{className:"text-sm font-medium text-accent",children:v.title}),_.jsx("span",{className:"text-xs text-gray-500 ml-2",children:y.map(N=>N.name).join(" & ")})]})]},x)})})]}),_.jsx("div",{className:"fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-dark-200 via-dark-200 to-transparent",children:_.jsx("div",{className:"flex gap-3 max-w-lg mx-auto",children:p?_.jsxs(_.Fragment,{children:[_.jsx("button",{onClick:f,className:"flex-1 py-3 bg-gray-700 text-white font-bold rounded-xl hover:bg-gray-600 transition-all active:scale-95",children:"🔄 席替え"}),_.jsx("button",{onClick:()=>{},className:"flex-1 py-3 bg-gradient-to-r from-secondary to-teal-400 text-white font-bold rounded-xl transition-all",children:"✅ 公開済み"})]}):_.jsx("button",{onClick:u,className:"flex-1 py-4 bg-gradient-to-r from-primary to-pink-500 text-white font-bold text-lg rounded-2xl shadow-lg hover:scale-105 transition-all active:scale-95 animate-glow",children:"🎉 結果を公開する"})})})]})},sk=({participants:r,results:e,seatAssignments:n,awards:s,layout:l,onReshuffle:c,onShowMatrix:u,reshuffleCount:f})=>{const[p,g]=ne.useState("countdown"),[v,x]=ne.useState(3),[y,N]=ne.useState(0),[R,F]=ne.useState(0),[z,L]=ne.useState(!1),[U,j]=ne.useState(null),Q=[...r].sort((Z,ce)=>{const we=n.find(Re=>Re.participantId===Z.id),fe=n.find(Re=>Re.participantId===ce.id);return((we==null?void 0:we.seatIndex)??0)-((fe==null?void 0:fe.seatIndex)??0)});ne.useEffect(()=>{if(f>1){g("done"),N(r.length),F(10);return}if(p==="countdown"){const Z=setInterval(()=>{x(ce=>ce<=1?(clearInterval(Z),g("seats"),0):ce-1)},1e3);return()=>clearInterval(Z)}if(p==="seats"){const Z=setInterval(()=>{N(ce=>ce>=r.length?(clearInterval(Z),setTimeout(()=>g("scores"),500),ce):ce+1)},400);return()=>clearInterval(Z)}if(p==="scores"){const Z=ie(),ce=setInterval(()=>{F(we=>we>=Z.length?(clearInterval(ce),setTimeout(()=>g("awards"),500),we):we+1)},800);return()=>clearInterval(ce)}p==="awards"&&setTimeout(()=>g("done"),2e3)},[p,r.length,f]);function ie(){const Z=[];for(let ce=0;ce<Q.length-1;ce++){const we=Q[ce],fe=Q[ce+1],Re=Bs(e,we.id,fe.id);Re&&Z.push({p1:we,p2:fe,result:Re})}return Z}const re=ie();return p==="countdown"?_.jsx("div",{className:"min-h-screen flex items-center justify-center bg-black",children:_.jsxs("div",{className:"text-center",children:[_.jsx("div",{className:"text-8xl font-black text-primary animate-pop",children:v},v),_.jsx("p",{className:"text-gray-400 mt-4",children:"運命の席順を発表..."})]})}):_.jsxs("div",{className:"min-h-screen px-6 py-8 pb-32",children:[_.jsxs("div",{className:"text-center mb-8",children:[_.jsx("h2",{className:"text-3xl font-black mb-2 animate-fade-in",children:_.jsx("span",{className:"bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent",children:"席順発表！"})}),_.jsx("p",{className:"text-gray-400 text-sm",children:"🍻 この席順で乾杯！"})]}),_.jsx("div",{className:"mb-8",children:_.jsx(ak,{participants:Q,revealedCount:y,layout:l})}),(p==="scores"||p==="awards"||p==="done")&&_.jsxs("div",{className:"mb-8",children:[_.jsx("h3",{className:"text-lg font-bold mb-4",children:"隣り合うペアの相性"}),_.jsx("div",{className:"space-y-3",children:re.map((Z,ce)=>{if(ce>=R&&p!=="done")return null;const we=ht.find(We=>We.id===Z.p1.avatar),fe=ht.find(We=>We.id===Z.p2.avatar),Re=`${Z.p1.id}-${Z.p2.id}`;return _.jsxs("div",{className:"animate-slide-up",style:{animationDelay:`${ce*.1}s`},children:[_.jsxs("button",{onClick:()=>j(U===Re?null:Re),className:"w-full bg-gray-800/60 rounded-2xl p-4 border border-gray-700/50 hover:border-gray-600 transition-all",children:[_.jsxs("div",{className:"flex items-center justify-between",children:[_.jsxs("div",{className:"flex items-center gap-3",children:[_.jsx("span",{className:"text-2xl",children:we==null?void 0:we.emoji}),_.jsx("span",{className:"text-sm font-medium",children:Z.p1.name}),_.jsx("span",{className:"text-gray-600",children:"×"}),_.jsx("span",{className:"text-sm font-medium",children:Z.p2.name}),_.jsx("span",{className:"text-2xl",children:fe==null?void 0:fe.emoji})]}),_.jsx("div",{className:"text-right",children:_.jsx(ok,{score:Z.result.displayScore})})]}),_.jsx("div",{className:"mt-2 text-sm text-secondary font-medium",children:Z.result.typeName})]}),U===Re&&_.jsx("div",{className:"mt-2 space-y-2 animate-slide-up",children:lk(Z.result).map((We,rt)=>_.jsxs("div",{className:"bg-gray-900/60 rounded-xl p-3 border border-gray-700/30",children:[_.jsx("div",{className:"text-xs text-accent mb-1",children:["💬 共通点探し","🔍 違い発見","💭 妄想系"][rt]}),_.jsx("p",{className:"text-sm",children:We})]},rt))})]},Re)})})]}),(p==="awards"||p==="done")&&_.jsxs("div",{className:"mb-8 animate-fade-in",children:[_.jsx("h3",{className:"text-lg font-bold mb-4",children:"称号発表！"}),_.jsx("div",{className:"space-y-3",children:s.map((Z,ce)=>{const we=Z.targetIds.map(fe=>r.find(Re=>Re.id===fe)).filter(Boolean);return _.jsx("div",{className:"bg-gradient-to-r from-gray-800/80 to-gray-900/80 rounded-2xl p-4 border border-accent/20 animate-pop",style:{animationDelay:`${ce*.15}s`},children:_.jsxs("div",{className:"flex items-center gap-3",children:[_.jsx("span",{className:"text-3xl",children:Z.emoji}),_.jsxs("div",{children:[_.jsx("div",{className:"font-bold text-accent",children:Z.title}),_.jsx("div",{className:"text-sm text-gray-300",children:Z.description}),_.jsx("div",{className:"text-xs text-gray-500 mt-1",children:we.map(fe=>fe.name).join(" & ")})]})]})},ce)})})]}),p==="done"&&_.jsx("p",{className:"text-center text-xs text-gray-600 mb-6",children:"※ あくまでお楽しみ診断です"}),p==="done"&&_.jsx("div",{className:"fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-dark-200 via-dark-200 to-transparent",children:_.jsxs("div",{className:"flex gap-3 max-w-lg mx-auto",children:[c&&_.jsx("button",{onClick:c,className:"flex-1 py-3 bg-gray-700 text-white font-bold rounded-xl hover:bg-gray-600 transition-all active:scale-95",children:"🔄 席替え"}),_.jsx("button",{onClick:u,className:"flex-1 py-3 bg-gradient-to-r from-secondary to-teal-400 text-white font-bold rounded-xl hover:scale-105 transition-all active:scale-95",children:"📊 相性一覧"})]})})]})};function ok({score:r}){const e=r>=85?"text-primary":r>=70?"text-accent":r>=55?"text-secondary":"text-gray-400";return _.jsxs("span",{className:`text-2xl font-black ${e}`,children:[r,_.jsx("span",{className:"text-sm font-normal text-gray-500",children:"点"})]})}function lk(r){var p,g,v;const e=Object.entries(r.axisScores);e.sort((x,y)=>y[1]-x[1]);const n=e[0][0],s=e[e.length-1][0],l=[],c=((p=fu[n])==null?void 0:p.common)??[],u=((g=fu[s])==null?void 0:g.diff)??[],f=((v=fu.L)==null?void 0:v.common)??[];return l.push(c[Math.floor(Math.random()*c.length)]??"好きな食べ物は？"),l.push(u[Math.floor(Math.random()*u.length)]??"お互いの趣味を紹介！"),l.push(f[Math.floor(Math.random()*f.length)]??"もし2人でドラマに出るなら？"),l}function ak({participants:r,revealedCount:e,layout:n}){const s=Math.ceil(r.length/2);if(n==="facing-long"||n==="facing-short"||n==="alternate"){const l=r.slice(0,s),c=r.slice(s);return _.jsxs("div",{className:"flex flex-col items-center gap-2",children:[_.jsx("div",{className:"flex gap-3 justify-center",children:l.map((u,f)=>_.jsx(sl,{participant:u,revealed:f<e,delay:f*.2},u.id))}),_.jsx("div",{className:"w-full max-w-sm h-3 bg-gradient-to-r from-amber-900/40 via-amber-800/60 to-amber-900/40 rounded-full my-2"}),_.jsx("div",{className:"flex gap-3 justify-center",children:c.map((u,f)=>_.jsx(sl,{participant:u,revealed:s+f<e,delay:(s+f)*.2},u.id))})]})}return n==="round"?_.jsx("div",{className:"flex justify-center",children:_.jsxs("div",{className:"relative",style:{width:280,height:260},children:[_.jsx("div",{className:"absolute rounded-full bg-amber-900/30 border-2 border-amber-800/40",style:{width:100*1.2,height:100*1.2,left:140-100*.6,top:130-100*.6}}),r.map((f,p)=>{const g=2*Math.PI*p/r.length-Math.PI/2,v=140+100*Math.cos(g)-32,x=130+100*Math.sin(g)-28;return _.jsx("div",{className:"absolute",style:{left:v,top:x},children:_.jsx(sl,{participant:f,revealed:p<e,delay:p*.2,compact:!0})},f.id)})]})}):_.jsxs("div",{className:"flex flex-col items-center gap-2",children:[_.jsx("div",{className:"flex gap-2 justify-center flex-wrap",children:r.map((l,c)=>_.jsx(sl,{participant:l,revealed:c<e,delay:c*.2},l.id))}),_.jsx("div",{className:"w-full max-w-sm h-3 bg-gradient-to-r from-amber-900/40 via-amber-800/60 to-amber-900/40 rounded-full"})]})}function sl({participant:r,revealed:e,delay:n,compact:s}){const l=ht.find(c=>c.id===r.avatar);return e?_.jsxs("div",{className:`${s?"w-14 p-1.5":"w-16 p-2"} bg-gray-800/80 rounded-xl border border-gray-600/50 text-center animate-slot-spin`,style:{animationDelay:`${n}s`},children:[_.jsx("div",{className:s?"text-xl":"text-2xl",children:l==null?void 0:l.emoji}),_.jsx("div",{className:`${s?"text-[10px]":"text-xs"} font-medium mt-1 truncate`,children:r.name})]}):_.jsx("div",{className:`${s?"w-14 h-14":"w-16 h-20"} bg-gray-800 rounded-xl border border-gray-700 flex items-center justify-center`,children:_.jsx("span",{className:"text-gray-600 text-lg",children:"?"})})}const ck={E:"テンション波長",C:"会話スタイル",V:"価値観ベクトル",L:"恋愛スタンス",H:"ユーモア相性"},uk=({participants:r,results:e,onBack:n})=>{const[s,l]=ne.useState(null),c=f=>f>=85?"bg-primary/80":f>=70?"bg-accent/60":f>=55?"bg-secondary/50":"bg-gray-600/40",u=f=>f>=85?"text-white font-bold":f>=70||f>=55?"text-white":"text-gray-300";return _.jsxs("div",{className:"min-h-screen px-4 py-8",children:[_.jsx("button",{onClick:n,className:"text-gray-400 hover:text-white mb-6 flex items-center gap-2 transition-colors",children:"← 席順に戻る"}),_.jsx("h2",{className:"text-2xl font-bold mb-6 animate-fade-in",children:_.jsx("span",{className:"bg-gradient-to-r from-secondary to-teal-400 bg-clip-text text-transparent",children:"相性マトリクス"})}),_.jsx("div",{className:"overflow-x-auto mb-8",children:_.jsxs("table",{className:"w-full border-collapse",children:[_.jsx("thead",{children:_.jsxs("tr",{children:[_.jsx("th",{className:"w-12"}),r.map(f=>{const p=ht.find(g=>g.id===f.avatar);return _.jsxs("th",{className:"p-1 text-center",children:[_.jsx("div",{className:"text-lg",children:p==null?void 0:p.emoji}),_.jsx("div",{className:"text-[10px] text-gray-400 truncate max-w-[48px]",children:f.name})]},f.id)})]})}),_.jsx("tbody",{children:r.map((f,p)=>{const g=ht.find(v=>v.id===f.avatar);return _.jsxs("tr",{children:[_.jsxs("td",{className:"p-1 text-center",children:[_.jsx("div",{className:"text-lg",children:g==null?void 0:g.emoji}),_.jsx("div",{className:"text-[10px] text-gray-400 truncate max-w-[48px]",children:f.name})]}),r.map((v,x)=>{if(p===x)return _.jsx("td",{className:"p-1",children:_.jsx("div",{className:"w-12 h-12 bg-gray-800/30 rounded-lg flex items-center justify-center",children:_.jsx("span",{className:"text-gray-700",children:"-"})})},v.id);const y=Bs(e,f.id,v.id);return y?_.jsx("td",{className:"p-1",children:_.jsx("button",{onClick:()=>l({p1:f,p2:v,result:y}),className:`w-12 h-12 rounded-lg flex items-center justify-center transition-all hover:scale-110 ${c(y.displayScore)}`,children:_.jsx("span",{className:`text-sm ${u(y.displayScore)}`,children:y.displayScore})})},v.id):_.jsx("td",{},v.id)})]},f.id)})})]})}),_.jsxs("div",{className:"flex items-center justify-center gap-4 mb-8 text-xs text-gray-400",children:[_.jsxs("div",{className:"flex items-center gap-1",children:[_.jsx("div",{className:"w-4 h-4 rounded bg-primary/80"})," 85+"]}),_.jsxs("div",{className:"flex items-center gap-1",children:[_.jsx("div",{className:"w-4 h-4 rounded bg-accent/60"})," 70-84"]}),_.jsxs("div",{className:"flex items-center gap-1",children:[_.jsx("div",{className:"w-4 h-4 rounded bg-secondary/50"})," 55-69"]}),_.jsxs("div",{className:"flex items-center gap-1",children:[_.jsx("div",{className:"w-4 h-4 rounded bg-gray-600/40"})," 40-54"]})]}),s&&_.jsx(dk,{p1:s.p1,p2:s.p2,result:s.result,onClose:()=>l(null)}),_.jsxs("div",{className:"mb-8",children:[_.jsx("h3",{className:"text-lg font-bold mb-4",children:"みんなのタイプ"}),_.jsx("div",{className:"grid grid-cols-2 gap-3",children:r.map(f=>{const p=ht.find(g=>g.id===f.avatar);return _.jsxs("div",{className:"bg-gray-800/60 rounded-xl p-3 border border-gray-700/50",children:[_.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[_.jsx("span",{className:"text-2xl",children:p==null?void 0:p.emoji}),_.jsx("span",{className:"font-medium text-sm",children:f.name})]}),_.jsxs("div",{className:"text-lg",children:[f.personalTypeEmoji," ",f.personalType]}),f.vector&&_.jsx("div",{className:"mt-2 space-y-1",children:["E","C","V","L","H"].map((g,v)=>_.jsxs("div",{className:"flex items-center gap-2",children:[_.jsx("span",{className:"text-[10px] text-gray-500 w-8",children:g}),_.jsx("div",{className:"flex-1 h-1.5 bg-gray-700 rounded-full overflow-hidden",children:_.jsx("div",{className:"h-full bg-gradient-to-r from-secondary to-primary rounded-full transition-all",style:{width:`${(f.vector[v]-1)/4*100}%`}})}),_.jsx("span",{className:"text-[10px] text-gray-500",children:f.vector[v].toFixed(1)})]},g))})]},f.id)})})]})]})};function dk({p1:r,p2:e,result:n,onClose:s}){const l=ht.find(u=>u.id===r.avatar),c=ht.find(u=>u.id===e.avatar);return _.jsx("div",{className:"fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-6",onClick:s,children:_.jsxs("div",{className:"bg-dark-200 rounded-2xl p-6 w-full max-w-sm border border-gray-700 animate-pop",onClick:u=>u.stopPropagation(),children:[_.jsxs("div",{className:"flex items-center justify-center gap-3 mb-4",children:[_.jsxs("div",{className:"text-center",children:[_.jsx("div",{className:"text-3xl",children:l==null?void 0:l.emoji}),_.jsx("div",{className:"text-sm font-medium",children:r.name})]}),_.jsx("div",{className:"text-2xl text-primary",children:"×"}),_.jsxs("div",{className:"text-center",children:[_.jsx("div",{className:"text-3xl",children:c==null?void 0:c.emoji}),_.jsx("div",{className:"text-sm font-medium",children:e.name})]})]}),_.jsxs("div",{className:"text-center mb-4",children:[_.jsx("span",{className:"text-4xl font-black text-primary",children:n.displayScore}),_.jsx("span",{className:"text-lg text-gray-400",children:"点"})]}),_.jsx("div",{className:"text-center text-secondary font-medium mb-6",children:n.typeName}),_.jsx("div",{className:"space-y-3 mb-6",children:["E","C","V","L","H"].map(u=>{const p=n.axisScores[u]*100;return _.jsxs("div",{children:[_.jsxs("div",{className:"flex justify-between text-xs mb-1",children:[_.jsx("span",{className:"text-gray-400",children:ck[u]}),_.jsxs("span",{className:"text-gray-300",children:[Math.round(p),"%"]})]}),_.jsx("div",{className:"h-2 bg-gray-700 rounded-full overflow-hidden",children:_.jsx("div",{className:"h-full bg-gradient-to-r from-primary to-secondary rounded-full transition-all duration-500",style:{width:`${p}%`}})})]},u)})}),_.jsx("button",{onClick:s,className:"w-full py-3 bg-gray-700 text-white font-bold rounded-xl hover:bg-gray-600 transition-all",children:"閉じる"})]})})}const hk=()=>{var L,U;const r=NI(),[e,n]=ne.useState("loading"),[s,l]=ne.useState(1),[c,u]=ne.useState(null);ne.useEffect(()=>{r.isReady&&e==="loading"&&n("top")},[r.isReady,e]),ne.useEffect(()=>{var Q;if(!r.roomData||!c)return;const j=r.roomData.config.state;c==="participant"&&(j==="diagnosing"&&r.myParticipant&&!r.myParticipant.completed?n("diagnosis"):j==="diagnosing"&&((Q=r.myParticipant)!=null&&Q.completed)||j==="admin-review"&&!r.revealed?n("waiting-results"):j==="results"&&r.revealed&&n("result")),c==="admin"&&j==="diagnosing"&&r.allCompleted&&e==="diagnosis"&&g()},[(L=r.roomData)==null?void 0:L.config.state,r.allCompleted,r.revealed,(U=r.myParticipant)==null?void 0:U.completed]);const f=ne.useCallback(async(j,Q)=>{const ie=await mI(j,Q);r.setRoomCode(ie),u("admin"),n("waiting")},[r]),p=ne.useCallback(async()=>{r.roomCode&&(await wI(r.roomCode),n("diagnosis"))},[r.roomCode]),g=ne.useCallback(async()=>{if(!r.roomCode||!r.roomData)return;const j=r.participants.map(fe=>{const Re=MI(fe.answers),We=AI(Re);return{...fe,vector:Re,personalType:We.name,personalTypeEmoji:We.emoji}}),Q=HI(j),ie=r.roomData.config.mode,re=r.roomData.config.layout,Z=dl(j,Q,re,ie),ce=Gm(j,Q,Z),we={};for(const fe of j)we[fe.id]={vector:fe.vector,personalType:fe.personalType,personalTypeEmoji:fe.personalTypeEmoji};await CI(r.roomCode,Q,Z,ce,we),n("admin-review")},[r.roomCode,r.roomData,r.participants]),v=ne.useCallback(async(j,Q)=>{r.roomCode&&await EI(r.roomCode,j,Q)},[r.roomCode]),x=ne.useCallback(async()=>{r.roomCode&&await SI(r.roomCode)},[r.roomCode]),y=ne.useCallback(async()=>{if(!r.roomCode||!r.roomData)return;const j=s+1,Q=r.roomData.config.mode,ie=r.roomData.config.layout,re=qI(r.participants,r.compatibilityResults,ie,Q,j,r.seatAssignments),Z=Gm(r.participants,r.compatibilityResults,re);await II(r.roomCode,re,Z),l(j)},[r.roomCode,r.roomData,r.participants,r.compatibilityResults,r.seatAssignments,s]),N=ne.useCallback(async j=>{await _I(j)&&(r.setRoomCode(j),u("participant"),n("profile"))},[r]),R=ne.useCallback(async j=>{r.roomCode&&(await yI(r.roomCode,{name:j.name,gender:j.gender,avatar:j.avatar}),n("waiting"))},[r.roomCode]),F=ne.useCallback(async j=>{r.roomCode&&(await xI(r.roomCode,j),n(c==="admin"?"waiting":"waiting-results"))},[r.roomCode,c]),z=ne.useCallback(async()=>{r.roomCode&&e==="waiting"&&c==="participant"&&await vI(r.roomCode),r.setRoomCode(""),u(null),n("top")},[r,e,c]);return e==="loading"?_.jsx("div",{className:"min-h-screen flex items-center justify-center",children:_.jsxs("div",{className:"text-center animate-pulse-slow",children:[_.jsx("div",{className:"text-4xl mb-4",children:"🍻"}),_.jsx("p",{className:"text-gray-400",children:"読み込み中..."})]})}):_.jsxs("div",{className:"max-w-lg mx-auto",children:[e==="top"&&_.jsx(YI,{onStart:()=>n("setup"),onJoin:()=>n("join")}),e==="setup"&&_.jsx(JI,{onComplete:f,onBack:()=>n("top")}),e==="join"&&_.jsx(ZI,{onJoin:N,onBack:()=>n("top")}),e==="profile"&&r.roomData&&_.jsx(ek,{mode:r.roomData.config.mode,usedAvatars:r.participants.map(j=>j.avatar),onSubmit:R,onBack:z}),e==="waiting"&&r.roomCode&&c&&_.jsx(tk,{roomCode:r.roomCode,participants:r.participants,role:c,onStartDiagnosis:p,onBack:z}),e==="diagnosis"&&r.myParticipant&&_.jsx(rk,{participant:r.myParticipant,onComplete:F}),e==="diagnosis"&&c==="admin"&&!r.myParticipant&&_.jsx("div",{className:"min-h-screen flex items-center justify-center px-6",children:_.jsxs("div",{className:"text-center",children:[_.jsx("div",{className:"text-4xl mb-4",children:"📊"}),_.jsx("h2",{className:"text-xl font-bold mb-2",children:"診断進行中"}),_.jsxs("p",{className:"text-gray-400 mb-4",children:[r.participants.filter(j=>j.completed).length," / ",r.participants.length," 人完了"]}),_.jsx("div",{className:"flex justify-center gap-2",children:[0,1,2].map(j=>_.jsx("div",{className:"w-3 h-3 bg-secondary rounded-full animate-bounce",style:{animationDelay:`${j*.15}s`}},j))})]})}),e==="waiting-results"&&_.jsx("div",{className:"min-h-screen flex items-center justify-center px-6",children:_.jsxs("div",{className:"text-center animate-pulse-slow",children:[_.jsx("div",{className:"text-6xl mb-4",children:"🔮"}),_.jsx("h2",{className:"text-2xl font-bold mb-2",children:"結果を待っています..."}),_.jsx("p",{className:"text-gray-400",children:r.allCompleted?"幹事が結果を準備中です":`${r.participants.filter(j=>j.completed).length} / ${r.participants.length} 人回答済み`}),_.jsx("div",{className:"mt-8 flex justify-center gap-2",children:[0,1,2].map(j=>_.jsx("div",{className:"w-3 h-3 bg-primary rounded-full animate-bounce",style:{animationDelay:`${j*.15}s`}},j))})]})}),e==="admin-review"&&r.roomData&&_.jsx(ik,{participants:r.participants,results:r.compatibilityResults,seatAssignments:r.seatAssignments,awards:r.awards,layout:r.roomData.config.layout,onTogglePair:v,onReveal:x,onReshuffle:y,revealed:r.revealed}),e==="result"&&r.roomData&&_.jsx(sk,{participants:r.participants,results:c==="admin"?r.compatibilityResults:r.visibleResults,seatAssignments:r.seatAssignments,awards:r.awards,layout:r.roomData.config.layout,onReshuffle:c==="admin"?y:void 0,onShowMatrix:()=>n("matrix"),reshuffleCount:s}),e==="matrix"&&_.jsx(uk,{participants:r.participants,results:c==="admin"?r.compatibilityResults:r.visibleResults,onBack:()=>n("result")})]})};h0.createRoot(document.getElementById("root")).render(_.jsx(Qm.StrictMode,{children:_.jsx(hk,{})}));
